(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [3138],
  {
          ...
          (e.prototype._blocks = function (e, t, r) {
            for (
              ...
              (M += n * m + s * v + o * y + a * g + c * d),
                ...
                (M &= 8191);
              var k = T;
              (k += n * b + s * m + o * v + a * y + c * g),
                (T = k >>> 13),
                (k &= 8191),
                (k += u * d + 5 * D * h + 5 * E * l + 5 * w * f + 5 * _ * p),
                (T += k >>> 13),
                (k &= 8191);
              var q = T;
    ...
    33138: function (e, t, r) {
      ...
      let k = ({ name: e, prefix: t, encode: r, decode: i }) =>
          new M(e, t, r, i),
        q = ({ prefix: e, name: t, alphabet: r }) => {
          let { encode: i, decode: n } = C(r, t);
          return k({ prefix: e, name: t, encode: i, decode: (e) => x(n(e)) });
        },
        $ = (e, t, r, i) => {
          let n = {};
        ...
        B = H({ prefix: "0", name: "base2", alphabet: "01", bitsPerChar: 1 }),
        V = H({
          prefix: "7",
          name: "base8",
          alphabet: "01234567",
        ...
        K = q({ prefix: "9", name: "base10", alphabet: "0123456789" }),
        W = H({
          prefix: "f",
          name: "base16",
      ...
      let eO = (e) => async (t) =>
        ...
        eP = eI({ name: "sha2-256", code: 18, encode: eO("SHA-256") }),
        eC = eI({ name: "sha2-512", code: 19, encode: eO("SHA-512") }),
        eA = {
          code: 0,
          name: "identity",
          encode: x,
        ...
        eU = "json",
        eM = 512,
        ek = (e) => eL.encode(JSON.stringify(e)),
        eq = (e) => JSON.parse(ej.decode(e));
      class e$ {
        constructor(e, t, r, i) {
          (this.code = t),
            (this.version = e),
        ...
        static asCID(e) {
          ...
          if (null != e && e.asCID === e) {
            ...
            return new e$(t, r, i, n || eK(t, r, i.bytes));
          }
        ...
        static create(e, t, r) {
          ...
          switch (e) {
            case 0:
              if (t === eB) return new e$(e, t, r, r.bytes);
              throw Error(
...
`,
      ...
      let e0 = eZ(
        ...
        e1 = eZ(
          ...
          (e) => {
            let t = O((e = e.substring(1)).length);
      ...
      function ts(e) {
        ...
        var s = n.join("."),
          ...
          a = tr.exec(e);
        return a && a[1] ? new e7(r, s, o, a[1]) : new e4(r, s, o);
      }
      var to = r(66736),
        ta = r(62873),
        tc = r(65755),
      ...
      let tp = "base10",
        ...
        ty = "utf8";
      function tv() {
        return e6((0, E.randomBytes)(32), td);
      }
      function tm(e) {
        return e6((0, D.vp)(e3(e, ty)), td);
      }
      function tb(e) {
        return Number(e6(e, tp));
      }
      function t_(e) {
        let t = e3(e, tg),
          r = t.slice(0, 1);
      ...
      var tD = Object.defineProperty,
        ...
        tP = (e, t, r) =>
          t in e
            ...
            : (e[t] = r),
        tC = (e, t) => {
          for (var r in t || (t = {})) tS.call(t, r) && tP(e, r, t[r]);
          if (tI) for (var r of tI(t)) tO.call(t, r) && tP(e, r, t[r]);
          return e;
        };
      let tA = {
      ...
      function tx() {
        return (
          "u" > typeof tl &&
          "u" > typeof tl.versions &&
          "u" > typeof tl.versions.node
        );
      }
      function tN() {
        return (
      ...
      function tR() {
        return !tx() && !!(0, ta.getNavigator)() && !!(0, ta.getDocument)();
      }
      function tT() {
        return tN()
          ? tA.reactNative
      ...
      function tM(e = to.FIVE_MINUTES, t) {
        let r, i, n;
        let s = (0, to.toMiliseconds)(e || to.FIVE_MINUTES);
        return {
          resolve: (e) => {
      ...
      function tz(e, t) {
        return (0, to.fromMiliseconds)(
          (t || Date.now()) + (0, to.toMiliseconds)(e)
        );
      }
      function tH(e) {
        return Date.now() >= (0, to.toMiliseconds)(e);
      }
      function tF(e, t) {
        return `${e}${t ? `:${t}` : ""}`;
      }
      ...
      async function tV({ id: e, topic: t, wcDeepLink: i }) {
        try {
          if (!i) return;
      ...
      async function tK(e, t) {
        try {
          return (
            (await e.getItem(t)) || (tR() ? localStorage.getItem(t) : void 0)
          );
        } catch (e) {
          console.error(e);
        }
      ...
      var tY = Object.defineProperty,
        ...
        t1 = (e, t, r) =>
          t in e
            ...
            : (e[t] = r),
        t5 = (e, t) => {
          for (var r in t || (t = {})) tZ.call(t, r) && t1(e, r, t[r]);
          if (tX) for (var r of tX(t)) t0.call(t, r) && t1(e, r, t[r]);
          return e;
        },
        t3 = (e, t) => tJ(e, tQ(t));
      function t6(e) {
      ...
      function re(e, t) {
        let { message: r, code: i } = t7[e];
        return { message: t ? `${r} ${t}` : r, code: i };
      }
      function rt(e, t) {
        let { message: r, code: i } = t9[e];
        return { message: t ? `${r} ${t}` : r, code: i };
      }
      function rr(e, t) {
        return (
      ...
      function rs(e, t) {
        return !!(t && rn(e)) || ("string" == typeof e && !!e.trim().length);
      }
      function ro(e, t) {
        return !!(t && rn(e)) || ("number" == typeof e && !isNaN(e));
      }
      function ra(e) {
        return !!(rs(e, !1) && e.includes(":")) && 2 === e.split(":").length;
      }
      function rc(e) {
        let t = !0;
        return (
          rr(e) ? e.length && (t = e.every((e) => rs(e, !1))) : (t = !1), t
        );
      }
      function ru(e, t) {
        let r = null;
      ...
      Approved: ${a.toString()}`
        ...
        Approved: ${n.toString()}`
          ...
          o.forEach((e) => {
            i ||
              (tL(n[e].methods, s[e].methods)
                ? tL(n[e].events, s[e].events) ||
                  (i = re(
                    "NON_CONFORMING_NAMESPACES",
      ...
      async function rv() {
        if (tN() && "u" > typeof r.g && null != r.g && r.g.NetInfo) {
      ...
      function rP(e) {
        ...
        if ("function" == typeof e.toJSON) return rP(e.toJSON());
      ...
      async function rT(e) {
        "function" == typeof e.dispose && (await rO(e.dispose));
      }
      function rL(e) {
      ...
      function rU() {
        return i || (i = rj("keyval-store", "keyval")), i;
      }
      function rM(e, t = rU()) {
        return t("readonly", (t) => rL(t.get(e)));
      }
      let rk = (e) =>
      ...
      var rH = (e = {}) => {
        ...
        let r = e.base && e.base.length > 0 ? `${e.base}:` : "",
          i = (e) => r + e;
        return (
          e.dbName && e.storeName && (t = rj(e.dbName, e.storeName)),
          {
            name: "idb-keyval",
            options: e,
            hasItem: async (e) => !(typeof (await rM(i(e), t)) > "u"),
            getItem: async (e) => (await rM(i(e), t)) ?? null,
            setItem: (e, r) =>
              (function (e, t, r = rU()) {
                return r("readwrite", (r) => (r.put(t, e), rL(r.transaction)));
              })(i(e), r, t),
            removeItem: (e) =>
              (function (e, t = rU()) {
                return t("readwrite", (t) => (t.delete(e), rL(t.transaction)));
              })(i(e), t),
            getKeys: () =>
              (function (e = rU()) {
                return e("readonly", (e) => {
                  var t;
                  if (e.getAllKeys) return rL(e.getAllKeys());
                  let r = [];
                  return ((t = (e) => r.push(e.key)),
                  (e.openCursor().onsuccess = function () {
                    this.result && (t(this.result), this.result.continue());
                  }),
                  rL(e.transaction)).then(() => r);
                });
              })(t),
            clear: () =>
              (function (e = rU()) {
                return e("readwrite", (e) => (e.clear(), rL(e.transaction)));
              })(t),
          }
        );
      };
      class rF {
        constructor() {
          this.indexedDb = (function (e = {}) {
            let t = {
              ...
              n = (e, r) => {
                if (t.watching)
                  for (let i of ((r = rA(r)), t.watchListeners)) i(e, r);
              },
              s = async () => {
                if (!t.watching)
                  for (let e in ((t.watching = !0), t.mounts))
                    t.unwatch[e] = await rR(t.mounts[e], n, e);
              },
              o = async () => {
                if (t.watching) {
              ...
              c = {
                hasItem(e, t = {}) {
                  let { relativeKey: i, driver: n } = r((e = rA(e)));
                  return rO(n.hasItem, i, t);
                },
                getItem(e, t = {}) {
                  let { relativeKey: i, driver: n } = r((e = rA(e)));
                  return rO(n.getItem, i, t).then((e) => rI(e));
                },
                getItems: (e, t) =>
                  a(e, t, (e) =>
                    e.driver.getItems
                      ...
                      : Promise.all(
                          e.items.map((t) =>
                            rO(e.driver.getItem, t.relativeKey, t.options).then(
                              (e) => ({ key: t.key, value: rI(e) })
                            )
                          )
                        )
                  ),
                getItemRaw(e, t = {}) {
                  ...
                  return n.getItemRaw
                    ? rO(n.getItemRaw, i, t)
                    : rO(n.getItem, i, t).then((e) =>
                        "string" == typeof e && e.startsWith(rC)
                          ? rS.from(e.slice(rC.length), "base64")
                          : e
                      );
                },
                async setItem(e, t, i = {}) {
                  if (void 0 === t) return c.removeItem(e);
                  let { relativeKey: s, driver: o } = r((e = rA(e)));
                  o.setItem &&
                    (await rO(o.setItem, s, rP(t), i),
                    o.watch || n("update", e));
                },
                async setItems(e, t) {
                  await a(e, t, async (e) => {
                ...
                async setItemRaw(e, t, i = {}) {
                  ...
                  let { relativeKey: s, driver: o } = r((e = rA(e)));
                  if (o.setItemRaw) await rO(o.setItemRaw, s, t, i);
                  else {
                    if (!o.setItem) return;
                    await rO(
                      o.setItem,
                ...
                async removeItem(e, t = {}) {
                  ...
                  let { relativeKey: i, driver: s } = r((e = rA(e)));
                  s.removeItem &&
                    (await rO(s.removeItem, i, t),
                ...
                async getMeta(e, t = {}) {
                  ...
                  if (
                    (n.getMeta && Object.assign(s, await rO(n.getMeta, i, t)),
                    !t.nativeOnly)
                  ) {
                    let e = await rO(n.getItem, i + "$", t).then((e) => rI(e));
                    e &&
                      "object" == typeof e &&
                ...
                async getKeys(e, t = {}) {
                  let r = i((e = rx(e)), !0),
                    ...
                    s = [];
                  for (let e of r) {
                    let r = (await rO(e.driver.getKeys, e.relativeBase, t))
                      .map((t) => e.mountpoint + rA(t))
                ...
                async clear(e, t = {}) {
                  (e = rx(e)),
                    await Promise.all(
                      i(e, !1).map(async (e) =>
                        e.driver.clear
                          ? rO(e.driver.clear, e.relativeBase, t)
                          : e.driver.removeItem
                          ? Promise.all(
                              (
                ...
                async dispose() {
                  await Promise.all(Object.values(t.mounts).map((e) => rT(e)));
                },
                watch: async (e) => (
                  await s(),
        ...
        async setItem(e, t) {
          await this.indexedDb.setItem(e, rz(t));
        }
        async removeItem(e) {
      ...
      !(function () {
        ...
        (e.prototype.getItem = function (e) {
          ...
          "u" > typeof rB && rB.localStorage
            ? (rV.exports = rB.localStorage)
            : "u" > typeof window && window.localStorage
            ? (rV.exports = window.localStorage)
            : (rV.exports = new e());
      })();
      class rW {
        constructor() {
          this.localStorage = rV.exports;
        }
        async getKeys() {
          return Object.keys(this.localStorage);
        }
        async getEntries() {
          return Object.entries(this.localStorage).map(rK);
        }
        async getItem(e) {
        ...
        async setItem(e, t) {
          this.localStorage.setItem(e, rz(t));
        }
        async removeItem(e) {
      ...
      let rG = async (e, t, r) => {
          ...
          await t.setItem(i, 1), r(t), rY(e, o);
        },
        rY = async (e, t) => {
          t.length &&
            t.forEach(async (t) => {
      ...
      var rQ = r(90772),
        rX = r(9107),
        rZ = r(38200);
      class r0 extends rZ.q {
        constructor(e) {
          super(), (this.opts = e), (this.protocol = "wc"), (this.version = 2);
        }
      }
      class r1 extends rZ.q {
        constructor(e, t) {
          super(),
            (this.core = e),
            (this.logger = t),
      ...
      class r3 extends rZ.q {
        constructor(e, t) {
          super(), (this.relayer = e), (this.logger = t);
        }
      }
      class r6 extends rZ.q {
        constructor(e) {
          super();
        }
      }
      ...
      class r8 extends rZ.q {
        constructor(e, t) {
          super(), (this.relayer = e), (this.logger = t);
        }
      }
      class r4 extends rZ.q {
        constructor(e, t) {
      ...
      let ii = "base64url",
        is = "base58btc";
      function io(e) {
        return e6(e3(rz(e), "utf8"), ii);
      }
      function ia(e) {
        return ["did", "key", "z" + e6(P([e3("K36", is), e]), is)].join(":");
      }
      function ic(e = (0, E.randomBytes)(32)) {
        return ir._w(e);
      }
      async function iu(e, t, r, i, n = (0, to.fromMiliseconds)(Date.now())) {
        var s, o;
        let a = { alg: "EdDSA", typ: "JWT" },
          c = { iss: ia(i.publicKey), sub: e, aud: t, iat: n, exp: n + r },
          u = e3(
            [io((s = { header: a, payload: c }).header), io(s.payload)].join(
              "."
            ),
            "utf8"
          );
        return [
          io(
            (o = { header: a, payload: c, signature: ir.Xx(i.secretKey, u) })
              .header
          ),
          io(o.payload),
          e6(o.signature, ii),
      ...
      r(43014);
      let ih = "INTERNAL_ERROR",
        il = "SERVER_ERROR",
        ip = [-32700, -32600, -32601, -32602, -32603],
        id = {
          PARSE_ERROR: { code: -32700, message: "Parse error" },
          INVALID_REQUEST: { code: -32600, message: "Invalid Request" },
          METHOD_NOT_FOUND: { code: -32601, message: "Method not found" },
          INVALID_PARAMS: { code: -32602, message: "Invalid params" },
          [ih]: { code: -32603, message: "Internal error" },
          [il]: { code: -32e3, message: "Server error" },
        };
      function ig(e) {
        return Object.keys(id).includes(e) ? id[e] : id[il];
      }
      function iy(e, t, r) {
      ...
      function i_(e, t, r) {
        return { id: r || im(), jsonrpc: "2.0", method: e, params: t };
      }
      function iw(e, t) {
        ...
        return {
          ...
          error:
            void 0 === (i = t)
              ? ig(ih)
              : ("string" == typeof i &&
                  (i = Object.assign(Object.assign({}, ig(il)), {
                    message: i,
                  })),
                void 0 !== r && (i.data = r),
                (n = i.code),
                ip.includes(n) &&
                  ((s = i.code),
                  (i = Object.values(id).find((e) => e.code === s) || id[il])),
                i),
        };
      }
      class iD {}
      ...
      function ix(e) {
        return iA(e) && "method" in e;
      }
      function iN(e) {
        return iA(e) && (iR(e) || iT(e));
      }
      function iR(e) {
        return "result" in e;
      }
      ...
      class iL extends iS {
        ...
        async request(e, t) {
          return this.requestStrict(
            i_(e.method, e.params || [], e.id || ib().toString()),
            t
          );
        }
      ...
      class ik {
        ...
        onPayload(e) {
          ...
          let t = "string" == typeof e.data ? r$(e.data) : e.data;
          this.events.emit("payload", t);
        }
        onError(e, t) {
          let r = this.parseError(t),
            i = iE(e, r.message || r.toString());
        ...
        emitError(e) {
          let t = this.parseError(
            Error(
              e?.message ||
                `WebSocket connection failed for host: ${iU(this.url)}`
            )
          );
      ...
      class iX {
        constructor(e, t, r, i) {
          (this.name = e),
            ...
            (this.baseEncode = r),
            (this.baseDecode = i),
            (this.encoder = new iG(e, t, r)),
            (this.decoder = new iY(e, t, i));
        }
        encode(e) {
          return this.encoder.encode(e);
        }
      ...
      let iZ = ({ name: e, prefix: t, encode: r, decode: i }) =>
          new iX(e, t, r, i),
        i0 = ({ prefix: e, name: t, alphabet: r }) => {
          let { encode: i, decode: n } = iB(r, t);
          return iZ({ prefix: e, name: t, encode: i, decode: (e) => iV(n(e)) });
        },
        i1 = (e, t, r, i) => {
          let n = {};
          for (let e = 0; e < t.length; ++e) n[t[e]] = e;
        ...
        i3 = ({ name: e, prefix: t, bitsPerChar: r, alphabet: i }) =>
          iZ({
            prefix: t,
            name: e,
            encode: (e) => i5(e, i, r),
      ...
      var i6 = Object.freeze({
        ...
        i4 = Object.freeze({
          __proto__: null,
          base10: i0({ prefix: "9", name: "base10", alphabet: "0123456789" }),
        }),
        i9 = Object.freeze({
          __proto__: null,
          base16: i3({
      ...
      let nh = Array.from(
        ...
        nl = nh.reduce((e, t, r) => ((e[r] = t), e), []),
        nf = nh.reduce((e, t, r) => ((e[t.codePointAt(0)] = r), e), []);
      ...
      let ng = (e, t, r = 0) => (nd.encode(e, t, r), t),
        ny = (e) => nd.encodingLength(e),
        nv = (e, t) => {
          let r = t.byteLength,
            i = ny(e),
            n = i + ny(r),
            s = new Uint8Array(n + r);
          return ng(e, s, 0), ng(r, s, i), s.set(t, n), new nm(e, r, t, s);
        };
      class nm {
        constructor(e, t, r, i) {
          (this.code = e), (this.size = t), (this.digest = r), (this.bytes = i);
      ...
      let nb = ({ name: e, code: t, encode: r }) => new n_(e, t, r);
      class n_ {
        constructor(e, t, r) {
          (this.name = e), (this.code = t), (this.encode = r);
        }
      ...
      var nE = Object.freeze({
          __proto__: null,
          sha256: nb({ name: "sha2-256", code: 18, encode: nw("SHA-256") }),
          sha512: nb({ name: "sha2-512", code: 19, encode: nw("SHA-512") }),
        }),
        nD = Object.freeze({
          __proto__: null,
          identity: {
      ...
      let nP = nO(
        ...
        nC = nO(
          ...
          (e) => {
            let t = (function (e = 0) {
              return null != globalThis.Buffer &&
                null != globalThis.Buffer.allocUnsafe
                ? nS(globalThis.Buffer.allocUnsafe(e))
                : new Uint8Array(e);
        ...
        nR = { logger: "error" },
        nT = { database: ":memory:" },
        nL = "client_ed25519_seed",
        nj = to.ONE_DAY,
        nU = to.SIX_HOURS,
        nM = "wss://relay.walletconnect.com",
        ...
        nF = 1e3 * to.FIVE_SECONDS,
        nB = {
          wc_pairingDelete: {
            req: { ttl: to.ONE_DAY, prompt: !1, tag: 1e3 },
            res: { ttl: to.ONE_DAY, prompt: !1, tag: 1001 },
          },
          wc_pairingPing: {
            req: { ttl: to.THIRTY_SECONDS, prompt: !1, tag: 1002 },
            res: { ttl: to.THIRTY_SECONDS, prompt: !1, tag: 1003 },
          },
          unregistered_method: {
            req: { ttl: to.ONE_DAY, prompt: !1, tag: 0 },
            res: { ttl: to.ONE_DAY, prompt: !1, tag: 0 },
          },
        },
        nV = {
        ...
        nG = "verify-api",
        nY = "https://verify.walletconnect.com",
      ...
      class nX {
        constructor(e, t) {
          (this.core = e),
            ...
            (this.core = e),
            (this.logger = (0, rX.generateChildLogger)(t, this.name));
        }
        get context() {
          return (0, rX.getLoggerContext)(this.logger);
        }
        get storageKey() {
          return (
            this.storagePrefix +
        ...
        async setKeyChain(e) {
          await this.core.storage.setItem(this.storageKey, tj(e));
        }
        async getKeyChain() {
          let e = await this.core.storage.getItem(this.storageKey);
          return "u" > typeof e ? tU(e) : void 0;
        }
        async persist() {
        ...
        isInitialized() {
          if (!this.initialized) {
            let { message: e } = re("NOT_INITIALIZED", this.name);
            throw Error(e);
          }
        }
      }
      class nZ {
        constructor(e, t, r) {
          (this.core = e),
            ...
            (this.getClientId = async () => (
              this.isInitialized(), ia(ic(await this.getClientSeed()).publicKey)
            )),
            (this.generateKeyPair = () => {
              ...
              let e = (function () {
                let e = I.Au();
                return {
                  privateKey: e6(e.secretKey, td),
                  publicKey: e6(e.publicKey, td),
                };
              })();
            ...
            (this.signJWT = async (e) => {
              this.isInitialized();
              let t = ic(await this.getClientSeed()),
                r = tv();
              return await iu(r, e, nj, t);
            }),
            (this.generateSharedKey = (e, t, r) => {
              this.isInitialized();
              let i = (function (e, t) {
                let r = I.gi(e3(e, td), e3(t, td), !0);
                return e6(new w.t(D.mE, r).expand(32), td);
              })(this.getPrivateKey(e), t);
              return this.setSymKey(i, r);
            }),
            (this.setSymKey = async (e, t) => {
              this.isInitialized();
              let r = t || e6((0, D.vp)(e3(e, td)), td);
            ...
            (this.encode = async (e, t, r) => {
              ...
              return (function (e) {
                var t;
                let r =
                  ((t = "u" > typeof e.type ? e.type : 0), e3(`${t}`, tp));
                if (1 === tb(r) && typeof e.senderPublicKey > "u")
                  throw Error("Missing sender public key for type 1 envelope");
                let i =
                    "u" > typeof e.senderPublicKey
                      ? e3(e.senderPublicKey, td)
                      : void 0,
                  n = "u" > typeof e.iv ? e3(e.iv, td) : (0, E.randomBytes)(12);
                return (function (e) {
                  if (1 === tb(e.type)) {
                    if (typeof e.senderPublicKey > "u")
                      throw Error(
                    ...
                    return e6(
                      P([e.type, e.senderPublicKey, e.iv, e.sealed]),
                      tg
                    );
                  }
                  return e6(P([e.type, e.iv, e.sealed]), tg);
                })({
                  type: r,
                  sealed: new _.OK(e3(e.symKey, td)).seal(n, e3(e.message, ty)),
                  iv: n,
                  senderPublicKey: i,
                });
            ...
            (this.decode = async (e, t, r) => {
              ...
              try {
                let r = this.getSymKey(e),
                  i = (function (e) {
                    let t = new _.OK(e3(e.symKey, td)),
                      { sealed: r, iv: i } = t_(e.encoded),
                      n = t.open(i, r);
            ...
            (this.getPayloadType = (e) => tb(t_(e).type)),
            (this.getPayloadSenderPublicKey = (e) => {
              let t = t_(e);
              return t.senderPublicKey ? e6(t.senderPublicKey, td) : void 0;
            }),
            (this.core = e),
            (this.logger = (0, rX.generateChildLogger)(t, this.name)),
            (this.keychain = r || new nX(this.core, this.logger));
        }
        get context() {
          return (0, rX.getLoggerContext)(this.logger);
        }
        ...
        async getClientSeed() {
          ...
          try {
            ...
            (e = tv()), await this.keychain.set(nL, e);
          }
          return (function (e, t = "utf8") {
            ...
            return ("utf8" === t || "utf-8" === t) &&
              null != globalThis.Buffer &&
              null != globalThis.Buffer.from
              ? nS(globalThis.Buffer.from(e, "utf-8"))
              : r.decoder.decode(`${r.prefix}${e}`);
          })(e, "base16");
        }
        getSymKey(e) {
      ...
      class n0 extends r5 {
        constructor(e, t) {
          super(e, t),
            ...
            (this.has = (e, t) => (
              this.isInitialized(), "u" > typeof this.get(e)[tm(t)]
            )),
            (this.del = async (e) => {
              this.isInitialized(),
            ...
            (this.logger = (0, rX.generateChildLogger)(e, this.name)),
            (this.core = t);
        }
        get context() {
          return (0, rX.getLoggerContext)(this.logger);
      ...
      class n1 extends r3 {
        constructor(e, t) {
          super(e, t),
            ...
            (this.name = "publisher"),
            (this.queue = new Map()),
            (this.publishTimeout = (0, to.toMiliseconds)(2 * to.TEN_SECONDS)),
              ...
              try {
                ...
                try {
                  await await tk(
                    ...
                    this.relayer.events.emit(nq.publish, u);
                } catch (e) {
                  if (
        ...
        rpcPublish(e, t, r, i, n, s, o) {
          var a, c, u, h;
          let l = {
            method: tG(i.protocol).publish,
            params: { topic: e, message: t, ttl: r, prompt: n, tag: s },
            id: o,
          };
          return (
            rn(null == (a = l.params) ? void 0 : a.prompt) &&
              (null == (c = l.params) || delete c.prompt),
            rn(null == (u = l.params) ? void 0 : u.tag) &&
        ...
        registerEventListeners() {
          this.relayer.core.heartbeat.on(rQ.HEARTBEAT_EVENTS.pulse, () => {
            if (this.needsTransportRestart) {
              (this.needsTransportRestart = !1),
                this.relayer.events.emit(nq.connection_stalled);
              return;
            }
            this.checkQueue();
          }),
            this.relayer.on(nq.message_ack, (e) => {
      ...
      var n3 = Object.defineProperty,
        ...
        n7 = (e, t, r) =>
          t in e
            ...
            : (e[t] = r),
        se = (e, t) => {
          for (var r in t || (t = {})) n4.call(t, r) && n7(e, r, t[r]);
          if (n8) for (var r of n8(t)) n9.call(t, r) && n7(e, r, t[r]);
          return e;
        },
        st = (e, t) => n6(e, n2(t));
      class sr extends r8 {
        ...
        async unsubscribeById(e, t, r) {
          ...
          try {
            ...
            let n = rt("USER_DISCONNECTED", `${this.name}, ${e}`);
        ...
        async rpcSubscribe(e, t) {
          ...
          try {
            await await tk(this.relayer.request(r), this.subscribeTimeout);
          } catch {
        ...
        async rpcBatchSubscribe(e) {
          if (!e.length) return;
          let t = {
            method: tG(e[0].relay.protocol).batchSubscribe,
        ...
        onSubscribe(e, t) {
          this.setSubscription(e, st(se({}, t), { id: e })),
            this.pending.delete(t.topic);
        }
        onBatchSubscribe(e) {
          e.length &&
            e.forEach((e) => {
              this.setSubscription(e.id, se({}, e)),
        ...
        getSubscription(e) {
          ...
          if (!t) {
            let { message: t } = re("NO_MATCHING_KEY", `${this.name}: ${e}`);
            throw Error(t);
          }
          return t;
        }
        deleteSubscription(e, t) {
          ...
          this.subscriptions.delete(e),
            ...
            this.events.emit(nH.deleted, st(se({}, r), { reason: t }));
        }
        async persist() {
        ...
        async restore() {
          try {
            ...
            if (this.subscriptions.size) {
              let { message: e } = re("RESTORE_WILL_OVERRIDE", this.name);
              throw (
                (this.logger.error(e),
                this.logger.error(
        ...
        async batchSubscribe(e) {
          ...
          rr(t) &&
            this.onBatchSubscribe(t.map((t, r) => st(se({}, e[r]), { id: t })));
        }
        async onConnect() {
        ...
        registerEventListeners() {
          this.relayer.core.heartbeat.on(
            rQ.HEARTBEAT_EVENTS.pulse,
            async () => {
              await this.checkPending();
            }
          ),
            this.relayer.on(nq.connect, async () => {
              await this.onConnect();
            }),
            this.relayer.on(nq.disconnect, () => {
              this.onDisconnect();
            }),
      ...
      var si = Object.defineProperty,
        ...
        sa = (e, t, r) =>
          t in e
            ...
            : (e[t] = r),
        sc = (e, t) => {
          for (var r in t || (t = {})) ss.call(t, r) && sa(e, r, t[r]);
          if (sn) for (var r of sn(t)) so.call(t, r) && sa(e, r, t[r]);
          return e;
        };
      class su extends r6 {
        constructor(e) {
          super(e),
            ...
            (this.registerProviderListeners = () => {
              this.provider.on(n$.payload, this.onPayloadHandler),
                this.provider.on(n$.connect, this.onConnectHandler),
                this.provider.on(n$.disconnect, this.onDisconnectHandler),
                this.provider.on(n$.error, this.onProviderErrorHandler);
            }),
            (this.core = e.core),
            (this.logger =
              "u" > typeof e.logger && "string" != typeof e.logger
                ? (0, rX.generateChildLogger)(e.logger, this.name)
                : (0, rX.pino)(
                    (0, rX.getDefaultLoggerOptions)({
                      level: e.logger || "error",
                    })
                  )),
            (this.messages = new n0(this.logger, e.core)),
            (this.subscriber = new sr(this, this.logger)),
            (this.publisher = new n1(this, this.logger)),
            (this.relayUrl = e?.relayUrl || nM),
        ...
        async init() {
          ...
          try {
            ...
            this.logger.warn(
              `Connection via ${this.relayUrl} failed, attempting to connect via failover domain ${nk}...`
            ),
              await this.restartTransport(nk);
          }
          (this.initialized = !0),
            setTimeout(async () => {
        ...
        async subscribe(e, t) {
          ...
          if (n) return n;
          let s = (t) => {
            t.topic === e && (this.subscriber.off(nH.created, s), i());
          };
          return (
            await Promise.all([
              new Promise((e) => {
                (i = e), this.subscriber.on(nH.created, s);
              }),
              new Promise(async (r) => {
            ...
            try {
              await Promise.all([
                new Promise((e) => {
                  ...
                  this.subscriber.once(nH.resubscribed, () => {
                    e();
                  });
                }),
              ...
              if ((this.logger.error(e), !this.isConnectionStalled(e.message)))
                throw e;
              this.provider.events.emit(n$.disconnect);
            } finally {
              (this.connectionAttemptInProgress = !1),
                (this.hasExperiencedNetworkDisruption = !1);
            }
                  ...
                  f = (function (e, t, i) {
                    let n = (function () {
                        ...
                        let t = e
                          ...
                          : void 0 !== e2 && e2.version
                          ? new e9(e2.version.slice(1))
                          : null;
        ...
        async onProviderPayload(e) {
          if (
            ...
            this.logger.debug("Emitting Relayer Payload"),
              this.logger.trace(sc({ type: "event", event: t.id }, s)),
              this.events.emit(t.id, s),
              await this.acknowledgePayload(e),
              await this.onMessageEvent(s);
          } else iN(e) && this.events.emit(nq.message_ack, e);
        }
        async onMessageEvent(e) {
          (await this.shouldIgnoreMessageEvent(e)) ||
            (this.events.emit(nq.message, e), await this.recordMessageEvent(e));
        }
        ...
        unregisterProviderListeners() {
          this.provider.off(n$.payload, this.onPayloadHandler),
            this.provider.off(n$.connect, this.onConnectHandler),
            this.provider.off(n$.disconnect, this.onDisconnectHandler),
            this.provider.off(n$.error, this.onProviderErrorHandler);
        }
        async registerEventListeners() {
          this.events.on(nq.connection_stalled, () => {
        ...
        onProviderDisconnect() {
          this.events.emit(nq.disconnect), this.attemptToReconnect();
        }
        attemptToReconnect() {
      ...
      var sh = Object.defineProperty,
        ...
        sd = (e, t, r) =>
          t in e
            ...
            : (e[t] = r),
        sg = (e, t) => {
          for (var r in t || (t = {})) sf.call(t, r) && sd(e, r, t[r]);
          if (sl) for (var r of sl(t)) sp.call(t, r) && sd(e, r, t[r]);
          return e;
        };
      class sy extends r2 {
            ...
            (this.getAll = (e) => (
              ...
              e
                ? this.values.filter((t) =>
                    Object.keys(e).every((r) => i$()(t[r], e[r]))
                  )
                : this.values
            )),
      ...
      class sv {
          ...
          (this.core = e),
            ...
            (this.ping = async (e) => {
              ...
              if (this.pairings.keys.includes(t)) {
                let e = await this.sendRequest(t, "wc_pairingPing", {}),
                  { done: r, resolve: i, reject: n } = tM();
                this.events.once(tF("pairing_ping", e), ({ error: e }) => {
                  e ? n(e) : i();
                }),
                  await r();
              }
            ...
            (this.sendResult = async (e, t, r) => {
              let i = iw(e, r),
                ...
                s = nB[(await this.core.history.get(t, e)).request.method].res;
            ...
            (this.sendError = async (e, t, r) => {
              let i = iE(e, r),
                ...
                o = nB[s.request.method]
                  ? nB[s.request.method].res
                  : nB.unregistered_method.res;
            ...
            (this.deletePairing = async (e, t) => {
              await this.core.relayer.unsubscribe(e),
                await Promise.all([
                  this.pairings.delete(e, rt("USER_DISCONNECTED")),
                  this.core.crypto.deleteSymKey(e),
                  t ? Promise.resolve() : this.core.expirer.del(e),
                ]);
            }),
            (this.cleanup = async () => {
              let e = this.pairings.getAll().filter((e) => tH(e.expiry));
            ...
            (this.onPairingPingRequest = async (e, t) => {
              ...
              try {
                this.isValidPing({ topic: e }),
                  ...
                  this.events.emit(nV.ping, { id: r, topic: e });
              } catch (t) {
            ...
            (this.onPairingPingResponse = (e, t) => {
              ...
              setTimeout(() => {
                iR(t)
                  ? this.events.emit(tF("pairing_ping", r), {})
                  : iT(t) &&
                    this.events.emit(tF("pairing_ping", r), { error: t.error });
              }, 500);
            }),
            ...
            (this.onUnknownRpcMethodRequest = async (e, t) => {
              ...
              try {
                ...
                let t = rt("WC_METHOD_UNSUPPORTED", i);
                await this.sendError(r, e, t), this.logger.error(t);
              } catch (t) {
                await this.sendError(r, e, t), this.logger.error(t);
              }
            ...
            (this.onUnknownRpcMethodResponse = (e) => {
              this.registeredMethods.includes(e) ||
                this.logger.error(rt("WC_METHOD_UNSUPPORTED", e));
            }),
            (this.isValidPair = (e) => {
              var t;
              if (!rf(e)) {
              ...
              if (
                null != r &&
                r.expiryTimestamp &&
                (0, to.toMiliseconds)(r?.expiryTimestamp) < Date.now()
              ) {
                let { message: e } = re(
                  "EXPIRED",
            ...
            (this.isValidPairingTopic = async (e) => {
              ...
              if (tH(this.pairings.get(e).expiry)) {
                await this.deletePairing(e);
                let { message: t } = re("EXPIRED", `pairing topic: ${e}`);
                throw Error(t);
              }
            }),
            (this.core = e),
            (this.logger = (0, rX.generateChildLogger)(t, this.name)),
            (this.pairings = new sy(
              this.core,
              this.logger,
              this.name,
              this.storagePrefix
        ...
        registerRelayerEvents() {
          this.core.relayer.on(nq.message, async (e) => {
            let { topic: t, message: r } = e;
            if (
              !this.pairings.keys.includes(t) ||
        ...
        registerExpirerEvents() {
          this.core.expirer.on(nW.expired, async (e) => {
            let { topic: t } = t$(e.target);
            t &&
              this.pairings.keys.includes(t) &&
              (await this.deletePairing(t, !0),
              this.events.emit(nV.expire, { topic: t }));
          });
        }
      }
      class sm extends r1 {
          ...
          super(e, t),
            ...
            (this.set = (e, t, r) => {
              ...
              let i = {
                ...
                chainId: r,
                expiry: tz(to.THIRTY_DAYS),
              };
              this.records.set(i.id, i), this.events.emit(nK.created, i);
            }),
        ...
        get pending() {
          ...
          return (
            this.values.forEach((t) => {
              ...
              let r = {
                topic: t.topic,
                request: i_(t.request.method, t.request.params, t.id),
                chainId: t.chainId,
              };
              return e.push(r);
            }),
        ...
        async persist() {
          await this.setJsonRpcRecords(this.values), this.events.emit(nK.sync);
        }
        async restore() {
          try {
        ...
        registerEventListeners() {
          this.events.on(nK.created, (e) => {
            let t = nK.created;
            this.logger.info(`Emitting ${t}`),
              this.logger.debug({ type: "event", event: t, record: e }),
              this.persist();
          }),
            this.events.on(nK.updated, (e) => {
              let t = nK.updated;
              this.logger.info(`Emitting ${t}`),
                this.logger.debug({ type: "event", event: t, record: e }),
                this.persist();
            }),
            this.events.on(nK.deleted, (e) => {
              let t = nK.deleted;
              this.logger.info(`Emitting ${t}`),
                this.logger.debug({ type: "event", event: t, record: e }),
                this.persist();
            }),
            this.core.heartbeat.on(rQ.HEARTBEAT_EVENTS.pulse, () => {
              this.cleanup();
            });
        }
        cleanup() {
          try {
            this.records.forEach((e) => {
              (0, to.toMiliseconds)(e.expiry || 0) - Date.now() <= 0 &&
      ...
      class sb extends r4 {
          ...
          super(e, t),
            ...
            (this.set = (e, t) => {
              ...
              this.expirations.set(r, i),
                ...
                this.events.emit(nW.created, { target: r, expiration: i });
            }),
            (this.get = (e) => {
              this.isInitialized();
              let t = this.formatTarget(e);
            ...
            (this.del = (e) => {
              if ((this.isInitialized(), this.has(e))) {
                ...
                this.expirations.delete(t),
                  this.events.emit(nW.deleted, { target: t, expiration: r });
              }
            }),
            (this.on = (e, t) => {
              this.events.on(e, t);
        ...
        formatTarget(e) {
          if ("string" == typeof e) return tq("topic", e);
          if ("number" == typeof e) return tq("id", e);
          let { message: t } = re("UNKNOWN_TYPE", `Target type: ${typeof e}`);
          throw Error(t);
        }
        ...
        async persist() {
          await this.setExpirations(this.values), this.events.emit(nW.sync);
        }
        async restore() {
          try {
        ...
        checkExpiry(e, t) {
          let { expiry: r } = t;
          (0, to.toMiliseconds)(r) - Date.now() <= 0 && this.expire(e, t);
        }
        expire(e, t) {
          this.expirations.delete(e),
            this.events.emit(nW.expired, { target: e, expiration: t });
        }
        checkExpirations() {
        ...
        registerEventListeners() {
          this.core.heartbeat.on(rQ.HEARTBEAT_EVENTS.pulse, () =>
            ...
            this.events.on(nW.created, (e) => {
              let t = nW.created;
              this.logger.info(`Emitting ${t}`),
                this.logger.debug({ type: "event", event: t, data: e }),
                this.persist();
            }),
            this.events.on(nW.expired, (e) => {
              let t = nW.expired;
              this.logger.info(`Emitting ${t}`),
                this.logger.debug({ type: "event", event: t, data: e }),
                this.persist();
            }),
            this.events.on(nW.deleted, (e) => {
              let t = nW.deleted;
              this.logger.info(`Emitting ${t}`),
                this.logger.debug({ type: "event", event: t, data: e }),
                this.persist();
      ...
      class s_ extends r9 {
        constructor(e, t) {
          super(e, t),
            ...
            (this.init = async (e) => {
              if (this.verifyDisabled || tN() || !tR()) return;
              ...
              if (!this.initialized) {
                this.removeIframe(), (this.verifyUrl = nJ);
                try {
                  await this.createIframe();
                } catch (e) {
                  this.logger.info(
            ...
            (this.resolve = async (e) => {
              ...
              try {
                ...
                this.logger.info(
                  ...
                  this.logger.info(i),
                  (t = await this.fetchAttestation(e.attestationId, nJ));
              }
              return t;
            }),
            (this.fetchAttestation = async (e, t) => {
              this.logger.info(`resolving attestation: ${e} from url: ${t}`);
              let r = this.startAbortTimer(2 * to.ONE_SECOND),
            ...
            (this.createIframe = async () => {
              ...
              await Promise.race([
                new Promise((r) => {
                  if (document.getElementById(nG)) return r();
                ...
                new Promise((e, r) =>
                  ...
                  }, (0, to.toMiliseconds)(to.FIVE_SECONDS))
                ),
              ]);
            }),
            (this.removeIframe = () => {
            ...
            (this.getVerifyUrl = (e) => {
              ...
              return (
                nQ.includes(t) ||
                  (this.logger.info(
                    `verify url: ${t}, not included in trusted list, assigning default: ${nY}`
                  ),
                  (t = nY)),
                t
              );
            ...
            (this.isDevEnv = tx() && iF.env.IS_VITEST);
        }
        get context() {
          return (0, rX.getLoggerContext)(this.logger);
        }
      ...
      class sw extends r7 {
        constructor(e, t) {
          super(e, t),
            ...
            (this.logger = (0, rX.generateChildLogger)(t, this.context));
        }
      }
      var sE = Object.defineProperty,
        ...
        sO = (e, t, r) =>
          t in e
            ...
            : (e[t] = r),
        sP = (e, t) => {
          for (var r in t || (t = {})) sI.call(t, r) && sO(e, r, t[r]);
          if (sD) for (var r of sD(t)) sS.call(t, r) && sO(e, r, t[r]);
          return e;
        };
      class sC extends r0 {
        constructor(e) {
          ...
          let t =
            "u" > typeof e?.logger && "string" != typeof e?.logger
              ...
              : (0, rX.pino)(
                  (0, rX.getDefaultLoggerOptions)({
                    level: e?.logger || nR.logger,
                  })
                );
          (this.logger = (0, rX.generateChildLogger)(t, this.name)),
            (this.heartbeat = new rQ.HeartBeat()),
            (this.crypto = new nZ(this, this.logger, e?.keychain)),
            (this.history = new sm(this, this.logger)),
            (this.expirer = new sb(this, this.logger)),
            (this.storage =
              null != e && e.storage
                ? e.storage
                : new rJ(sP(sP({}, nT), e?.storageOptions))),
            (this.relayer = new su({
              core: this,
              logger: this.logger,
              relayUrl: this.relayUrl,
            ...
            (this.pairing = new sv(this, this.logger)),
            (this.verify = new s_(this.projectId || "", this.logger)),
            (this.echoClient = new sw(this.projectId || "", this.logger));
        }
        static async init(e) {
          let t = new sC(e);
          await t.initialize();
      ...
      let sA = "client",
        sx = `wc@2:${sA}:`,
        sN = { name: sA, logger: "error" },
        sR = "WALLETCONNECT_DEEPLINK_CHOICE",
        sT = "Proposal expired",
        sL = to.SEVEN_DAYS,
        sj = {
          wc_sessionPropose: {
            req: { ttl: to.FIVE_MINUTES, prompt: !0, tag: 1100 },
            res: { ttl: to.FIVE_MINUTES, prompt: !1, tag: 1101 },
          },
          wc_sessionSettle: {
            req: { ttl: to.FIVE_MINUTES, prompt: !1, tag: 1102 },
            res: { ttl: to.FIVE_MINUTES, prompt: !1, tag: 1103 },
          },
          wc_sessionUpdate: {
            req: { ttl: to.ONE_DAY, prompt: !1, tag: 1104 },
            res: { ttl: to.ONE_DAY, prompt: !1, tag: 1105 },
          },
          wc_sessionExtend: {
            req: { ttl: to.ONE_DAY, prompt: !1, tag: 1106 },
            res: { ttl: to.ONE_DAY, prompt: !1, tag: 1107 },
          },
          wc_sessionRequest: {
            req: { ttl: to.FIVE_MINUTES, prompt: !0, tag: 1108 },
            res: { ttl: to.FIVE_MINUTES, prompt: !1, tag: 1109 },
          },
          wc_sessionEvent: {
            req: { ttl: to.FIVE_MINUTES, prompt: !0, tag: 1110 },
            res: { ttl: to.FIVE_MINUTES, prompt: !1, tag: 1111 },
          },
          wc_sessionDelete: {
            req: { ttl: to.ONE_DAY, prompt: !1, tag: 1112 },
            res: { ttl: to.ONE_DAY, prompt: !1, tag: 1113 },
          },
          wc_sessionPing: {
            req: { ttl: to.THIRTY_SECONDS, prompt: !1, tag: 1114 },
            res: { ttl: to.THIRTY_SECONDS, prompt: !1, tag: 1115 },
          },
        },
        sU = { min: to.FIVE_MINUTES, max: to.SEVEN_DAYS },
        sM = { idle: "IDLE", active: "ACTIVE" },
        sk = ["wc_sessionPropose", "wc_sessionRequest", "wc_authRequest"];
      var sq = Object.defineProperty,
        ...
        sV = (e, t, r) =>
          t in e
            ...
            : (e[t] = r),
        sK = (e, t) => {
          for (var r in t || (t = {})) sF.call(t, r) && sV(e, r, t[r]);
          if (sH) for (var r of sH(t)) sB.call(t, r) && sV(e, r, t[r]);
          return e;
        },
        sW = (e, t) => s$(e, sz(t));
      class sG extends it {
        constructor(e) {
          super(e),
            ...
            (this.initialized = !1),
            (this.ignoredPayloadTypes = [1]),
            (this.requestQueue = { state: sM.idle, queue: [] }),
            (this.sessionRequestQueue = { state: sM.idle, queue: [] }),
            (this.requestQueueDelay = to.ONE_SECOND),
            (this.init = async () => {
              this.initialized ||
                (await this.cleanup(),
                this.registerRelayerEvents(),
                ...
                this.client.core.pairing.register({ methods: Object.keys(sj) }),
                (this.initialized = !0),
                setTimeout(() => {
                  (this.sessionRequestQueue.queue =
                    this.getPendingSessionRequests()),
                    this.processSessionRequestQueue();
                }, (0, to.toMiliseconds)(this.requestQueueDelay)));
            }),
            (this.connect = async (e) => {
              ...
              let h = await this.client.core.crypto.generateKeyPair(),
                l = sj.wc_sessionPropose.req.ttl || to.FIVE_MINUTES,
                f = tz(l),
                p = sK(
                  {
                    requiredNamespaces: i,
                ...
                { reject: d, resolve: g, done: y } = tM(l, sT);
              if (
                (this.events.once(
                  tF("session_connect"),
              ...
              return (
                await this.setProposal(v, sK({ id: v }, p)),
                { uri: c, approval: y }
              );
            }),
            (this.pair = async (e) => (
            ...
            (this.approve = async (e) => {
              ...
              s &&
                ...
                await this.client.proposal.delete(t, rt("USER_DISCONNECTED")),
              ...
              try {
                ...
                throw (
                  ...
                  this.client.session.delete(l, rt("USER_DISCONNECTED")),
                  await this.client.core.relayer.unsubscribe(l),
                  e)
                );
              }
              return (
                await this.setExpiry(l, tz(sL)),
                {
                  topic: l,
                  acknowledged: () =>
                    new Promise((e) =>
            ...
            (this.update = async (e) => {
              ...
              let { topic: t, namespaces: r } = e,
                ...
                { done: n, resolve: s, reject: o } = tM();
              return (
                this.events.once(tF("session_update", i), ({ error: e }) => {
                  e ? o(e) : s();
                }),
            ...
            (this.extend = async (e) => {
              ...
              let { topic: t } = e,
                ...
                { done: i, resolve: n, reject: s } = tM();
              return (
                this.events.once(tF("session_extend", r), ({ error: e }) => {
                  e ? s(e) : n();
                }),
                await this.setExpiry(t, tz(sL)),
                { acknowledged: i }
              );
            }),
            (this.request = async (e) => {
              ...
              let {
                  ...
                  request: r,
                  topic: i,
                  expiry: n = sj.wc_sessionRequest.req.ttl,
                } = e,
                s = im(),
                {
                  done: o,
                  resolve: a,
                  reject: c,
                } = tM(n, "Request expired. Please try again.");
              return (
                this.events.once(
                  tF("session_request", s),
                  ({ error: e, result: t }) => {
                    e ? c(e) : a(t);
                  }
                ),
                await Promise.all([
                  new Promise(async (e) => {
                    await this.sendRequest({
                      ...
                      params: {
                        request: sW(sK({}, r), { expiryTimestamp: tz(n) }),
                        chainId: t,
                      },
                      expiry: n,
                      throwOnFailedPublish: !0,
                  ...
                  new Promise(async (e) => {
                    tV({
                      id: s,
                      topic: i,
                      wcDeepLink: await tK(this.client.core.storage, sR),
                    }),
                      e();
                  }),
                  o(),
            ...
            (this.respond = async (e) => {
              ...
              iR(r)
                ...
                : iT(r) && (await this.sendError(i, t, r.error)),
            ...
            (this.ping = async (e) => {
              ...
              if (this.client.session.keys.includes(t)) {
                let e = await this.sendRequest({
                  ...
                  { done: r, resolve: i, reject: n } = tM();
                this.events.once(tF("session_ping", e), ({ error: e }) => {
                  e ? n(e) : i();
                }),
                  await r();
              } else
            ...
            (this.deleteProposal = async (e, t) => {
              await Promise.all([
                this.client.proposal.delete(e, rt("USER_DISCONNECTED")),
            ...
            (this.deletePendingSessionRequest = async (e, t, r = !1) => {
              await Promise.all([
                ...
                r &&
                  ((this.sessionRequestQueue.state = sM.idle),
            ...
            (this.setProposal = async (e, t) => {
              await this.client.proposal.set(e, t),
                this.client.core.expirer.set(
                  e,
                  tz(sj.wc_sessionPropose.req.ttl)
                );
            }),
            (this.setPendingSessionRequest = async (e) => {
              let { id: t, topic: r, params: i, verifyContext: n } = e,
                s =
                  i.request.expiryTimestamp || tz(sj.wc_sessionRequest.req.ttl);
            ...
            (this.sendResult = async (e) => {
              let { id: t, topic: r, result: i, throwOnFailedPublish: n } = e,
                ...
                a =
                  sj[(await this.client.core.history.get(r, t)).request.method]
                    .res;
              n
                ? ((a.internal = sW(sK({}, a.internal), {
                    throwOnFailedPublish: !0,
                  })),
            ...
            (this.sendError = async (e, t, r) => {
              let i = iE(e, r),
                ...
                s =
                  sj[(await this.client.core.history.get(t, e)).request.method]
                    .res;
            ...
            (this.cleanup = async () => {
              ...
              this.client.session.getAll().forEach((t) => {
                ...
                this.client.proposal.getAll().forEach((e) => {
                  tH(e.expiryTimestamp) && t.push(e.id);
                }),
                await Promise.all([
            ...
            (this.processRequestsQueue = async () => {
              if (this.requestQueue.state === sM.active) {
                this.client.logger.info(
              ...
              for (
                ...
                this.requestQueue.state = sM.active;
              ...
              this.requestQueue.state = sM.idle;
            }),
            (this.processRequest = (e) => {
              let { topic: t, payload: r } = e,
                i = r.method;
            ...
            (this.onSessionProposeRequest = async (e, t) => {
              let { params: r, id: i } = t;
              try {
                this.isValidConnect(sK({}, t.params));
                let n = r.expiryTimestamp || tz(sj.wc_sessionPropose.req.ttl),
                  s = sK({ id: i, pairingTopic: e, expiryTimestamp: n }, r);
            ...
            (this.onSessionProposeResponse = async (e, t) => {
              ...
              if (iR(t)) {
                ...
                iT(t) &&
                  ...
                  this.events.emit(tF("session_connect"), { error: t.error }));
            }),
            (this.onSessionSettleRequest = async (e, t) => {
              ...
              try {
                ...
                await this.sendResult({ id: t.id, topic: e, result: !0 }),
                  this.events.emit(tF("session_connect"), { session: u }),
            ...
            (this.onSessionSettleResponse = async (e, t) => {
              ...
              iR(t)
                ? (await this.client.session.update(e, { acknowledged: !0 }),
                  this.events.emit(tF("session_approve", r), {}))
                : iT(t) &&
                  (await this.client.session.delete(e, rt("USER_DISCONNECTED")),
                  this.events.emit(tF("session_approve", r), {
                    error: t.error,
                  }));
            }),
            (this.onSessionUpdateRequest = async (e, t) => {
              ...
              try {
                ...
                this.isValidUpdate(sK({ topic: e }, r)),
            ...
            (this.onSessionUpdateResponse = (e, t) => {
              let { id: r } = t;
              iR(t)
                ? this.events.emit(tF("session_update", r), {})
                : iT(t) &&
                  this.events.emit(tF("session_update", r), { error: t.error });
            }),
            (this.onSessionExtendRequest = async (e, t) => {
              let { id: r } = t;
              try {
                this.isValidExtend({ topic: e }),
                  await this.setExpiry(e, tz(sL)),
            ...
            (this.onSessionExtendResponse = (e, t) => {
              let { id: r } = t;
              iR(t)
                ? this.events.emit(tF("session_extend", r), {})
                : iT(t) &&
                  this.events.emit(tF("session_extend", r), { error: t.error });
            }),
            ...
            (this.onSessionPingResponse = (e, t) => {
              ...
              setTimeout(() => {
                iR(t)
                  ? this.events.emit(tF("session_ping", r), {})
                  : iT(t) &&
                    this.events.emit(tF("session_ping", r), { error: t.error });
              }, 500);
            }),
            (this.onSessionDeleteRequest = async (e, t) => {
              ...
              try {
                this.isValidDisconnect({ topic: e, reason: t.params }),
                  await Promise.all([
                    new Promise((t) => {
                      this.client.core.relayer.once(nq.publish, async () => {
            ...
            (this.onSessionRequest = async (e, t) => {
              let { id: r, params: i } = t;
              try {
                this.isValidRequest(sK({ topic: e }, i));
                let t = tm(JSON.stringify(i_("wc_sessionRequest", i, r))),
            ...
            (this.onSessionRequestResponse = (e, t) => {
              let { id: r } = t;
              iR(t)
                ? this.events.emit(tF("session_request", r), {
                    result: t.result,
                  })
                : iT(t) &&
                  this.events.emit(tF("session_request", r), {
            ...
            (this.cleanupPendingSentRequestsForTopic = ({
              ...
              r.length > 0 &&
                r
                  ...
                  .forEach((e) => {
                    this.events.emit(tF("session_request", e.request.id), {
                      error: t,
                    });
                  });
            }),
            (this.processSessionRequestQueue = () => {
              if (this.sessionRequestQueue.state === sM.active) {
                this.client.logger.info(
              ...
              try {
                (this.sessionRequestQueue.state = sM.active),
            ...
            (this.isValidConnect = async (e) => {
              ...
              if (
                (rn(r) || (await this.isValidPairingTopic(r)),
                (t = !1),
                o
                  ? o &&
                    rr(o) &&
              ...
              rn(i) ||
                ...
                rn(s) || this.validateSessionProps(s, "sessionProperties");
            }),
            ...
            (this.isValidApprove = async (e) => {
              if (!rf(e))
                throw Error(
                  re("MISSING_OR_INVALID", `approve() params: ${e}`).message
                );
              let {
                id: t,
                namespaces: r,
              ...
              let a = rd(s.requiredNamespaces, r, "approve()");
              ...
              rn(n) || this.validateSessionProps(n, "sessionProperties");
            }),
            ...
            (this.isValidSessionSettleRequest = (e) => {
              ...
              let o =
                ...
                t);
              if (o) throw Error(o.message);
              let a = rh(n, "onSessionSettleRequest()");
              if (a) throw Error(a.message);
              if (tH(s)) {
                let { message: e } = re("EXPIRED", "onSessionSettleRequest()");
                throw Error(e);
              }
            }),
            (this.isValidUpdate = async (e) => {
              ...
              let s = rd(i.requiredNamespaces, r, "update()");
            ...
            (this.isValidRequest = async (e) => {
              ...
              if (
                !(
                  ...
                  (function (e, t) {
                    ...
                    return (
                      Object.values(e).forEach((e) => {
                        t2(e.accounts).includes(t) && r.push(...e.methods);
                      }),
                      r
                    );
                  })(o, n).includes(t)
              ...
              if (s && (!ro(s, !1) || !(s <= sU.max) || !(s >= sU.min))) {
                let { message: e } = re(
                  "MISSING_OR_INVALID",
                  `request() expiry: ${s}. Expiry must be a number (in seconds) between ${sU.min} and ${sU.max}`
                );
                throw Error(e);
              }
            }),
              ...
              if (
                !(
                  ...
                  (function (e, t) {
                    ...
                    return (
                      Object.values(e).forEach((e) => {
                        t2(e.accounts).includes(t) && r.push(...e.events);
                      }),
                      r
                    );
                  })(s, n).includes(t)
        ...
        registerRelayerEvents() {
          this.client.core.relayer.on(nq.message, async (e) => {
            let { topic: t, message: r } = e;
            if (
              this.ignoredPayloadTypes.includes(
        ...
        registerExpirerEvents() {
          this.client.core.expirer.on(nW.expired, async (e) => {
            let { topic: t, id: r } = t$(e.target);
        ...
        registerPairingEvents() {
          this.client.core.pairing.events.on(nV.create, (e) =>
            this.onPairingCreated(e)
          );
        }
        isValidPairingTopic(e) {
          ...
          if (tH(this.client.core.pairing.pairings.get(e).expiry)) {
            let { message: t } = re("EXPIRED", `pairing topic: ${e}`);
            throw Error(t);
          }
        }
        async isValidSessionTopic(e) {
          ...
          if (tH(this.client.session.get(e).expiry)) {
        ...
        async isValidProposalId(e) {
          ...
          if (tH(this.client.proposal.get(e).expiryTimestamp)) {
            await this.deleteProposal(e);
            let { message: t } = re("EXPIRED", `proposal id: ${e}`);
            throw Error(t);
          }
        }
      }
      class sY extends sy {
        constructor(e, t) {
          super(e, t, "proposal", sx), (this.core = e), (this.logger = t);
        }
      }
      class sJ extends sy {
        constructor(e, t) {
          super(e, t, "session", sx), (this.core = e), (this.logger = t);
        }
      }
      class sQ extends sy {
        constructor(e, t) {
          super(e, t, "request", sx, (e) => e.id),
            (this.core = e),
            (this.logger = t);
        }
      }
        ...
        constructor(e) {
          ...
          let t =
            "u" > typeof e?.logger && "string" != typeof e?.logger
              ...
              : (0, rX.pino)(
                  (0, rX.getDefaultLoggerOptions)({
                    level: e?.logger || sN.logger,
                  })
                );
          (this.core = e?.core || new sC(e)),
            (this.logger = (0, rX.generateChildLogger)(t, this.name)),
            (this.session = new sJ(this.core, this.logger)),
            (this.proposal = new sY(this.core, this.logger)),
            (this.pendingRequest = new sQ(this.core, this.logger)),
            (this.engine = new sG(this));
        }
        static async init(e) {
          let t = new sX(e);
        ...
        async send(e, t) {
          ...
          try {
            let t = rz(e),
              r = await s0()(
                this.url,
                Object.assign(Object.assign({}, s1), { body: t })
              ),
              i = await r.json();
        ...
        async register(e = this.url) {
          ...
          try {
            if (!this.disableProviderPing) {
              let t = rz({ id: 1, jsonrpc: "2.0", method: "test", params: [] });
              await s0()(e, Object.assign(Object.assign({}, s1), { body: t }));
            }
            this.onOpen();
          } catch (t) {
      ...
      let s3 = "error",
        s6 = "wc@2:universal_provider:",
        s2 = { DEFAULT_CHAIN_CHANGED: "default_chain_changed" };
      var s8 =
          "u" > typeof globalThis
            ? globalThis
            : "u" > typeof window
       ...
       */ !(function (e, t) {
        (function () {
          ...
          var eX = {
            ...
            eZ = parseFloat,
            e0 = parseInt,
            e1 = "object" == typeof s8 && s8 && s8.Object === Object && s8,
            e5 =
          ...
          function tB(e) {
            return tk(e) ? e.match(eB) || [] : e.split("");
          }
          function tV(e) {
          ...
          var tK = tS({
            ...
            tW = (function e(t) {
              ...
              function rL(e, t, i, n, s, o) {
                ...
                if (b) {
                  ...
                  var I,
                    ...
                    $ = nv(e),
                    z = $ == d || $ == g;
                  if (sq(e)) return iU(e, c);
                  if ($ == m || $ == u || (z && !s)) {
                    if (((a = h || z ? {} : nb(e)), !c))
                      return h
                        ? ((M = (q = a) && iF(e, op(e), q)), iF(e, ny(e), M))
                        : ((k = rx(a, e)), iF(e, ng(e), k));
                  } else {
                    if (!eQ[$]) return s ? e : {};
                    a = (function (e, t, r) {
                      var i,
                ...
                return (
                  ta(B || e, function (r, n) {
                    B && (r = e[(n = r)]), rP(a, n, rL(r, t, i, n, e, o));
                  }),
                  a
                );
              }
              ...
              function r5(e, t, i) {
                t = iT(t, e);
                var n = null == (e = nA(e, t)) ? e : e[nk(nQ(t))];
              ...
              function r8(e) {
                return (
                  !(!sV(e) || (eL && eL in e)) && (sH(e) ? ek : eu).test(nq(e))
                );
              }
              function r4(e) {
              ...
              function iS(e, t) {
                return (
                  (t = iT(t, e)), null == (e = nA(e, t)) || delete e[nk(nQ(t))]
                );
              }
              function iO(e, t, r, i) {
              ...
              function i3(e, t) {
                ...
                return tk(t) ? iL(tB(n), 0, e).join("") : n.slice(0, e);
              }
              function i6(e) {
                return function (t, i, n) {
                  return (
              ...
              function i8(e, t, i, n, s, o, a, c, u, h) {
                ...
                var y = [e, t, s, d, f, g, p, c, u, h],
                  v = i.apply(r, y);
                return nI(e) && nN(v, y), (v.placeholder = n), nL(v, e, t);
              }
              function i4(e) {
                var t = eE[e];
                return function (e, r) {
                ...
                if (
                      ...
                      (R = function e() {
                        for (
                          var t = -1,
                            ...
                            s = em(n + r),
                            o =
                              this && this !== e3 && this instanceof e ? O : w;
                          ++i < n;
                  ...
                  var v,
                    ...
                    R =
                      ...
                      function e() {
                        return (
                          this && this !== e3 && this instanceof e ? N : P
                        ).apply(x ? A : this, arguments);
                      });
                return nL((g ? ig : nN)(R, y), e, t);
              }
              function nt(e, t, i, n) {
              ...
              function nb(e) {
                return "function" != typeof e.constructor || nO(e)
                  ? {}
                  : rg(eK(e));
              }
              function n_(e) {
                return sj(e) || sL(e) || !!(e6 && e && e[e6]);
              }
              function nw(e, t) {
                var r = typeof e;
                return (
              ...
              ((t9 && nv(new t9(new ArrayBuffer(1))) != O) ||
                (t7 && nv(new t7()) != y) ||
                (re && nv(re.resolve()) != b) ||
                (rt && nv(new rt()) != w) ||
                (rr && nv(new rr()) != I)) &&
...
`
              ...
              var nz = ip(function (e, t) {
                ...
                nH = ip(function (e, t) {
                  ...
                  return (
                    sk(i) && (i = r),
                    sk(e) ? rM(e, rF(t, 1, sk, !0), nl(i, 2)) : []
                  );
                }),
                nF = ip(function (e, t) {
                  var i = nQ(t);
                  return (
                    sk(i) && (i = r), sk(e) ? rM(e, rF(t, 1, sk, !0), r, i) : []
                  );
                });
              function nB(e, t, r) {
              ...
              var n5 = ip(function (e) {
                  return iI(rF(e, 1, sk, !0));
                }),
                n3 = ip(function (e) {
                  var t = nQ(e);
                  return sk(t) && (t = r), iI(rF(e, 1, sk, !0), nl(t, 2));
                }),
                n6 = ip(function (e) {
                  var t = nQ(e);
                  return (
              ...
              var n4 = ip(function (e, t) {
                ...
                n7 = ip(function (e) {
                  var t = nQ(e);
                  return sk(t) && (t = r), iA(tu(e, sk), nl(t, 2));
                }),
                se = ip(function (e) {
                  var t = nQ(e);
                  return (
                    (t = "function" == typeof t ? t : r), iA(tu(e, sk), r, t)
                  );
                }),
                st = ip(n2),
                sr = ip(function (e) {
              ...
              var sR = i2(rX),
                ...
                sL = r3(
                  ...
                  : function (e) {
                      return (
                        sK(e) && eR.call(e, "callee") && !e1.call(e, "callee")
                      );
                    },
                sj = em.isArray,
                sU = e7
              ...
              return (
                ...
                (rd.sampleSize = function (e, t, i) {
                  return (
                    ...
                    (sj(e)
                      ? function (e, t) {
                          return nU(iH(e), rT(t, 0, e.length));
                        }
                      : function (e, t) {
                          var r = ow(e);
                          return nU(r, rT(t, 0, r.length));
                        })(e, t)
                  );
                }),
                ...
                (rd.toPath = function (e) {
                  return sj(e) ? tf(e, nk) : sZ(e) ? [e] : iH(nM(s7(e)));
                }),
                (rd.toPlainObject = s9),
                ...
                (rd.escape = function (e) {
                  return (e = s7(e)) && H.test(e) ? e.replace($, tU) : e;
                }),
                ...
                (rd.forIn = function (e, t) {
                  return null == e ? e : rB(e, nl(t, 3), op);
                }),
                ...
                (rd.lte = s5),
                (rd.max = function (e) {
                  return e && e.length ? rz(e, ok, rX) : r;
                }),
                ...
                (rd.min = function (e) {
                  return e && e.length ? rz(e, ok, r7) : r;
                }),
...
`) +
                ...
                (rd.unescape = function (e) {
                  return (e = s7(e)) && z.test(e) ? e.replace(q, tK) : e;
                }),
      ...
      var s9 = Object.defineProperty,
        ...
        on = (e, t, r) =>
          t in e
            ...
            : (e[t] = r),
        os = (e, t) => {
          for (var r in t || (t = {})) or.call(t, r) && on(e, r, t[r]);
          if (ot) for (var r of ot(t)) oi.call(t, r) && on(e, r, t[r]);
          return e;
        },
        oo = (e, t) => s7(e, oe(t));
      function oa(e, t, r) {
      ...
      function ol(e) {
        ...
        for (let [o, a] of Object.entries(e)) {
          let e = t8(o) ? [o] : a.chains,
            c = a.methods || [],
            u = a.events || [],
            h = a.rpcMap || {},
            l = t4(o);
          s[l] = oo(os(os({}, s[l]), a), {
            chains: tB(e, null == (t = s[l]) ? void 0 : t.chains),
            methods: tB(c, null == (r = s[l]) ? void 0 : r.methods),
            events: tB(u, null == (i = s[l]) ? void 0 : i.events),
            rpcMap: os(os({}, h), null == (n = s[l]) ? void 0 : n.rpcMap),
          });
        }
        return s;
      }
      ...
      class ov {
        constructor(e) {
          (this.name = "polkadot"),
            ...
            (this.events = og("events")),
            (this.client = og("client")),
        ...
        setDefaultChain(e, t) {
          this.httpProviders[e] || this.setHttpProvider(e, t),
            (this.chainId = e),
            this.events.emit(s2.DEFAULT_CHAIN_CHANGED, `${this.name}:${e}`);
        }
        getAccounts() {
        ...
        createHttpProvider(e, t) {
          let r = t || oa(e, this.namespace, this.client.core.projectId);
          if (!r) throw Error(`No RPC url provided for chainId: ${e}`);
          return new iL(new s5(r, og("disableProviderPing")));
        }
      }
      class om {
        constructor(e) {
        ...
        createHttpProvider(e, t) {
          let r =
            t ||
            oa(`${this.name}:${e}`, this.namespace, this.client.core.projectId);
          if (!r) throw Error(`No RPC url provided for chainId: ${e}`);
          return new iL(new s5(r, og("disableProviderPing")));
        }
        setHttpProvider(e, t) {
      ...
      class oI {
        ...
        setDefaultChain(e, t) {
          if (((this.chainId = e), !this.httpProviders[e])) {
            let r = t || oa(`${this.name}:${e}`, this.namespace);
            if (!r) throw Error(`No RPC url provided for chainId: ${e}`);
        ...
        createHttpProvider(e, t) {
          let r = t || oa(e, this.namespace);
          return typeof r > "u"
            ? void 0
            : new iL(new s5(r, og("disableProviderPing")));
        }
      }
      var oS = Object.defineProperty,
        ...
        oN = (e, t, r) =>
          t in e
            ...
            : (e[t] = r),
        oR = (e, t) => {
          for (var r in t || (t = {})) oA.call(t, r) && oN(e, r, t[r]);
          if (oC) for (var r of oC(t)) ox.call(t, r) && oN(e, r, t[r]);
          return e;
        },
        oT = (e, t) => oO(e, oP(t));
      class oL {
          ...
          (this.events = new (b())()),
            ...
            (this.logger =
              "u" > typeof e?.logger && "string" != typeof e?.logger
                ? e.logger
                : (0, rX.pino)(
                    (0, rX.getDefaultLoggerOptions)({ level: e?.logger || s3 })
                  )),
                  ...
                  let t = (function (e) {
                    ...
                    for (let [r, i] of Object.entries(e)) {
                      let e = i.methods || [],
                        n = i.events || [],
                        s = i.accounts || [],
                        o = t8(r) ? [r] : i.chains ? i.chains : ou(i.accounts);
                      t[r] = { chains: o, methods: e, events: n, accounts: s };
                    }
                    return t;
                  })(e.namespaces);
                  (this.namespaces = oh(this.namespaces, t)),
                    this.persist("namespaces", this.namespaces);
                })
                .catch((e) => {
                  if (e.message !== sT) throw e;
                  t++;
                });
          } while (!this.session);
        ...
        async createClient() {
          (this.client =
            ...
            (await sX.init({
              logger: this.providerOpts.logger || s3,
              relayUrl:
        ...
        createProviders() {
          ...
          let e = [
            ...new Set(Object.keys(this.session.namespaces).map((e) => t4(e))),
          ];
          oy("client", this.client),
            oy("events", this.events),
            oy("disableProviderPing", this.disableProviderPing),
            e.forEach((e) => {
              if (!this.session) return;
              let t = (function (e, t) {
                ...
                r = ou(t),
                i = oT(
                  oR({}, oh(this.namespaces, this.optionalNamespaces)[e]),
                  { accounts: t, chains: r }
                );
              switch (e) {
                case "eip155":
                  this.rpcProviders[e] = new om({ namespace: i });
                  break;
                case "solana":
                  this.rpcProviders[e] = new ob({ namespace: i });
                  break;
                case "cosmos":
                  this.rpcProviders[e] = new o_({ namespace: i });
                  break;
                case "polkadot":
                  this.rpcProviders[e] = new ov({ namespace: i });
                  break;
                case "cip34":
                  this.rpcProviders[e] = new ow({ namespace: i });
                  break;
                case "elrond":
          ...
          this.client.on("session_ping", (e) => {
            ...
            this.client.on("session_event", (e) => {
              ...
              if ("accountsChanged" === r.name) {
                let e = r.data;
                e && rr(e) && this.events.emit("accountsChanged", e.map(of));
              } else if ("chainChanged" === r.name) {
                let e = t.chainId,
                  r = t.event.data,
                  i = t4(e),
                  n = op(e) !== op(r) ? `${i}:${op(r)}` : e;
            ...
            this.client.on("session_update", ({ topic: e, params: t }) => {
              ...
              (this.session = oT(oR({}, n), { namespaces: i })),
            ...
            this.client.on("session_delete", async (e) => {
              await this.cleanup(),
                ...
                this.events.emit(
                  "disconnect",
                  oT(oR({}, rt("USER_DISCONNECTED")), { data: e.topic })
                );
            }),
            this.on(s2.DEFAULT_CHAIN_CHANGED, (e) => {
        ...
        validateChain(e) {
          ...
          if (t && r) return [t, r];
          let i = t4(Object.keys(this.namespaces)[0]),
        ...
        persist(e, t) {
          this.client.core.storage.setItem(`${s6}/${e}`, t);
        }
        async getFromStore(e) {
          return await this.client.core.storage.getItem(`${s6}/${e}`);
        }
      }
      let oj = ["eth_sendTransaction", "personal_sign"],
        oU = [
          "eth_accounts",
          "eth_requestAccounts",
        ...
        oM = ["chainChanged", "accountsChanged"],
        ok = [
          "chainChanged",
          "accountsChanged",
          "message",
      ...
      var oq = Object.defineProperty,
        ...
        oV = (e, t, r) =>
          t in e
            ...
            : (e[t] = r),
        oK = (e, t) => {
          for (var r in t || (t = {})) oF.call(t, r) && oV(e, r, t[r]);
          if (oH) for (var r of oH(t)) oB.call(t, r) && oV(e, r, t[r]);
          return e;
        },
        oW = (e, t) => o$(e, oz(t));
      function oG(e) {
      ...
      class oJ {
        ...
        async connect(e) {
          ...
          let { required: t, optional: r } = (function (e) {
            ...
            if (!rr(t)) throw Error("Invalid chains");
            let c = {
                chains: t,
                methods: i || oj,
                events: s || oM,
                rpcMap: oK({}, t.length ? { [oG(t)]: a[oG(t)] } : {}),
              },
              u = s?.filter((e) => !oM.includes(e)),
              h = i?.filter((e) => !oj.includes(e));
            if (
              !r &&
              !o &&
              !n &&
            ...
            let l = (u?.length && h?.length) || !r,
              f = {
                ...
                methods: [
                  ...new Set(c.methods.concat(null != n && n.length ? n : oU)),
                ],
                events: [
                  ...new Set(c.events.concat(null != o && o.length ? o : ok)),
                ],
                rpcMap: a,
              };
            return {
          ...
          try {
              ...
              this.rpc.showQrModal &&
                ...
                await this.signer
                  .connect(
                    oW(
                      oK(
                        { namespaces: oK({}, t && { [this.namespace]: t }) },
            ...
            this.setChainIds(this.rpc.chains.length ? this.rpc.chains : n),
              this.setAccounts(n),
              this.events.emit("connect", { chainId: oY(this.chainId) });
          } catch (e) {
        ...
        registerEventListeners() {
          this.signer.on("session_event", (e) => {
            ...
            this.signer.on("chainChanged", (e) => {
              let t = parseInt(e);
              (this.chainId = t),
                this.events.emit("chainChanged", oY(this.chainId)),
                this.persist();
            }),
        ...
        getRpcConfig(e) {
          ...
          let o = i.length ? e?.methods || oj : [],
            a = i.length ? e?.events || oM : [],
            c = e?.optionalMethods || [],
            u = e?.optionalEvents || [],
        ...
        async initialize(e) {
          if (
            ...
            (this.chainId = this.rpc.chains.length
              ? oG(this.rpc.chains)
              : oG(this.rpc.optionalChains)),
            (this.signer = await oL.init({
            ...
            if (e)
              try {
                this.modal = new e(
                  oK({ projectId: this.rpc.projectId }, this.rpc.qrModalOptions)
                );
              } catch (e) {
                throw (
    ...
    53401: function (e, t, r) {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 }),
        r(70655).__exportStar(r(32568), t);
    },
    ...
    1614: function (e, t, r) {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 }),
        r(70655).__exportStar(r(44174), t);
    },
    72030: function (e) {
      "use strict";
      e.exports = function () {
    ...
    52939: function (e, t, r) {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 }),
        r(70655).__exportStar(r(88766), t);
    },
    88766: function (e, t) {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 }),
    ...
    72307: function (e, t, r) {
      ...
      function eD(e) {
        ...
        return (
          (t = (function (e) {
            return null != e && eL(e.length) && !eT(e)
              ? (function (e, t) {
                  var r,
                    i = eN(e),
                    n = !i && ex(e),
      ...
      function eS(e, t) {
        ...
        return !(!ej(r) || (F && F in r)) && (eT(r) ? V : D).test(eC(r))
          ? r
          : void 0;
      }
      ...
      var eM = L
        ...
        : function (e) {
            return eU(e) && eL(e.length) && !!S[e_(e)];
          };
      e.exports = function (e, t) {
