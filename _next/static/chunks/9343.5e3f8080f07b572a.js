    ...
    75740: function (e, t, s) {
      ...
      let g = f({
        ...
        m = {
          ...
          push(e, t) {
            e !== g.view &&
              ((g.view = e), t && (g.data = t), g.history.push(e));
          },
          reset(e) {
          ...
          replace(e) {
            g.history.length > 1 &&
              ((g.history[g.history.length - 1] = e), (g.view = e));
          },
          goBack() {
          ...
          setWalletConnectDeepLink(e, t) {
            try {
              localStorage.setItem(
                b.WALLETCONNECT_DEEPLINK_CHOICE,
          ...
          setModalVersionInStorage() {
            try {
              "u" > typeof localStorage &&
                localStorage.setItem(b.WCM_VERSION, "2.6.2");
            } catch {
        ...
        v = {
          ...
          initialize() {
            y.enabled &&
              ...
              (y.userSessionId = crypto.randomUUID());
          },
        ...
        O = {
          ...
          setConfig(e) {
            ...
            v.initialize(),
              ...
              I.setIsCustomDesktop(
                !!(null == (s = e.desktopWallets) ? void 0 : s.length)
              ),
              b.setModalVersionInStorage(),
              Object.assign(C, e);
          },
        };
      ...
      async function D(e, t) {
        let s = k({ sdkType: "wcm", sdkVersion: U }, t),
          r = new URL(e, M);
        return (
          r.searchParams.append("projectId", O.state.projectId),
      ...
      let P = {
        ...
        getWalletImageUrl: (e) =>
          `${M}/w3m/v1/getWalletImage/${e}?projectId=${O.state.projectId}&sdkType=wcm&sdkVersion=${U}`,
        getAssetImageUrl: (e) =>
          `${M}/w3m/v1/getAssetImage/${e}?projectId=${O.state.projectId}&sdkType=wcm&sdkVersion=${U}`,
      };
      ...
      let $ = b.isMobile(),
          ...
          async getRecomendedWallets() {
            ...
            if (b.isArray(e)) {
              let t = { recommendedIds: e.join(",") },
                ...
                r = Object.values(s);
              r.sort((t, s) => e.indexOf(t.id) - e.indexOf(s.id)),
                (V.recomendedWallets = r);
            } else {
              let { chains: e, isAuth: s } = I.state,
                r = e?.join(","),
                o = b.isArray(t),
                a = {
                  page: 1,
                ...
                { listings: n } = $
                  ? await P.getMobileListings(a)
                  : await P.getDesktopListings(a);
        ...
        z = {
          ...
          open: async (e) =>
            new Promise((t) => {
              let { isUiLoaded: s, isDataLoaded: r } = I.state;
              if (
                (b.removeWalletConnectDeepLink(),
      ...
      let X = f({
        ...
        Z = f({ open: !1, message: "", variant: "success" }),
        ee = {
          state: Z,
          subscribe: (e) => h(Z, () => e(Z)),
          openToast(e, t) {
