  ...
  [1391],
  {
    41391: function (e, t, r) {
      ...
      class y extends HTMLElement {
        ...
        _$EO(e, t, r = f) {
          ...
          if (void 0 !== o && !0 === r.reflect) {
            ...
            (this._$El = e),
              null == l ? this.removeAttribute(o) : this.setAttribute(o, l),
              (this._$El = null);
          }
        }
        _$AK(e, t) {
            ...
            let e = i.getPropertyOptions(o),
              l =
                "function" == typeof e.converter
                  ...
                  : g;
            (this._$El = o),
              (this[o] = l.fromAttribute(t, e.type)),
              (this._$El = null);
          }
        }
        requestUpdate(e, t, r) {
          ...
          void 0 !== e &&
            ((
              (r = r || this.constructor.getPropertyOptions(e)).hasChanged || v
            )(this[e], t)
      ...
      (y[b] = !0),
        ...
        null == w || w({ ReactiveElement: y }),
        (null !== (ef = m.reactiveElementVersions) && void 0 !== ef
          ? ef
          : (m.reactiveElementVersions = [])
        ).push("1.6.3");
      let x = window,
        $ = x.trustedTypes,
        C = $ ? $.createPolicy("lit-html", { createHTML: (e) => e }) : void 0,
        A = "$lit$",
...
\f\r"'\`<>=]|("|')|))|$)`,
        ...
        q = new WeakMap(),
        F = k.createTreeWalker(k, 129, null, !1);
      function K(e, t) {
        ...
        for (let t = 0; t < r; t++) {
          ...
          l +=
            a === R
              ? r + E
              : c >= 0
              ? (i.push(n), r.slice(0, c) + A + r.slice(c) + _ + h)
              : r + _ + (-2 === c ? (i.push(void 0), t) : h);
        }
      ...
      class Y {
        constructor({ strings: e, _$litType$: t }, r) {
          ...
          for (; null !== (i = F.nextNode()) && n.length < a; ) {
            if (1 === i.nodeType) {
              ...
              if (i.data === O) n.push({ type: 2, index: o });
              else {
                let e = -1;
                for (; -1 !== (e = i.data.indexOf(_, e + 1)); )
                  n.push({ type: 7, index: o }), (e += _.length - 1);
              }
            }
            o++;
          }
        ...
        static createElement(e, t) {
          let r = k.createElement("template");
      ...
      function G(e, t, r = e, i) {
        ...
        return (
          (null == n ? void 0 : n.constructor) !== s &&
            (null === (l = null == n ? void 0 : n._$AO) ||
              void 0 === l ||
              l.call(n, !1),
            ...
            void 0 !== i
              ...
              : (r._$Cl = n)),
          void 0 !== n && (t = G(e, n._$AS(e, t.values), n, i)),
          t
        );
      }
      class X {
        ...
        u(e) {
          ...
          for (; void 0 !== s; ) {
            if (a === s.index) {
              let t;
              2 === s.type
                ? (t = new J(l, l.nextSibling, this, e))
                : 1 === s.type
                ? (t = new s.ctor(l, s.name, s.strings, this, e))
                : 6 === s.type && (t = new el(l, this, e)),
                this._$AV.push(t),
                (s = i[++n]);
            }
      ...
      class J {
        ...
        _(e) {
          this._$AH !== V && T(this._$AH)
            ...
            : this.$(k.createTextNode(e)),
            (this._$AH = e);
        }
        g(e) {
          var t;
          let { values: r, _$litType$: i } = e,
            o =
              "number" == typeof i
                ? this._$AC(e)
                : (void 0 === i.el &&
                    (i.el = Y.createElement(K(i.h, i.h[0]), this.options)),
                  i);
          if (
            (null === (t = this._$AH) || void 0 === t ? void 0 : t._$AD) === o
          )
            this._$AH.v(r);
          else {
            let e = new X(o, this),
        ...
        _$AC(e) {
          ...
          return void 0 === t && q.set(e.strings, (t = new Y(e))), t;
        }
        T(e) {
          ...
          for (let o of e)
            i === t.length
              ? t.push(
                  (r = new J(this.k(I()), this.k(I()), this, this.options))
                )
              : (r = t[i]),
              r._$AI(o),
              i++;
      ...
      class ee {
        ...
        _$AI(e, t = this, r, i) {
          let o = this.strings,
            l = !1;
          if (void 0 === o)
            (l = !T((e = G(this, e, t, 0))) || (e !== this._$AH && e !== B)) &&
              (this._$AH = e);
          else {
            let i, a;
            let n = e;
            for (e = o[0], i = 0; i < o.length - 1; i++)
              (a = G(this, n[r + i], t, i)) === B && (a = this._$AH[i]),
                l || (l = !T(a) || a !== this._$AH[i]),
                a === V
                  ? (e = V)
                  : e !== V && (e += (null != a ? a : "") + o[i + 1]),
                (this._$AH[i] = a);
          }
          l && !i && this.j(e);
        }
      ...
      class eo extends ee {
        ...
        _$AI(e, t = this) {
          var r;
          if (
            (e = null !== (r = G(this, e, t, 0)) && void 0 !== r ? r : V) === B
          )
            return;
          let i = this._$AH,
            o =
      ...
      null == ea || ea(Y, J),
        (null !== (eb = x.litHtmlVersions) && void 0 !== eb
          ? eb
          : (x.litHtmlVersions = [])
        ).push("2.8.0");
      let en = (e, t, r) => {
      ...
      class es extends y {
        ...
        update(e) {
          ...
          this.hasUpdated ||
            ...
            super.update(e),
            (this._$Do = en(t, this.renderRoot, this.renderOptions));
        }
        connectedCallback() {
          var e;
      ...
      (es.finalized = !0),
        (es._$litElement$ = !0),
        null === (ey = globalThis.litElementHydrateSupport) ||
          void 0 === ey ||
          ey.call(globalThis, { LitElement: es });
      let ec = globalThis.litElementPolyfillSupport;
      null == ec || ec({ LitElement: es }),
        (null !== (ex = globalThis.litElementVersions) && void 0 !== ex
          ? ex
      ...
      null !=
        (null === (e$ = window.HTMLSlotElement) || void 0 === e$
          ? void 0
          : e$.prototype.assignedElements) ||
        ((e, t) =>
      ...
      let eI = (e) => e(),
        eT = (e, t, r = eA.duration) =>
          new Proxy(
            { animations: e.map(eI).filter(Boolean), duration: r, options: t },
            eM
          ),
        eP = (e) => e.animations[0],
        eM = {
          get: (e, t) => {
            ...
            switch (t) {
              ...
              case "finished":
                return (
                  e.finished ||
                    (e.finished = Promise.all(e.animations.map(eS)).catch(eO)),
                  e.finished
                );
              case "stop":
                return () => {
      ...
      function eZ(e, t, r, i) {
        ...
        let o = (t) =>
          (function (e, t, r, i, o) {
            ...
            let n = 0;
            do
              (l = eH((a = t + (r - t) / 2), i, o) - e) > 0 ? (r = a) : (t = a);
      ...
      let eB =
        ...
        eF = {
          ease: eZ(0.25, 0.1, 0.25, 1),
          "ease-in": eZ(0.42, 0, 1, 1),
          "ease-in-out": eZ(0.42, 0, 0.58, 1),
          "ease-out": eZ(0, 0, 0.58, 1),
        },
        eK = /\((.*?)\)/;
      function eQ(e) {
        if (eV(e)) return e;
      ...
      class eY {
        constructor(
          ...
          let d = (function (
            ...
            return (
              ...
              (o) => {
                ...
                return (
                  (n = ((l = a), eW(r) ? r[eU(0, r.length, l)] : r)(n)),
                  ej(e[a], e[a + 1], n)
                );
              }
            );
          ...
          (this.tick = (t) => {
            ...
            e(p),
              void 0 === this.pauseTime &&
              ("finished" === this.playState || i >= this.totalDuration + l)
      ...
      function e0(e) {
        return (
          eJ.has(e) || eJ.set(e, { transforms: [], values: new Map() }),
          eJ.get(e)
        );
      }
      let e1 = ["", "X", "Y", "Z"],
        e2 = { x: "translateX", y: "translateY", z: "translateZ" },
        e5 = {
          syntax: "<angle>",
          initialValue: "0deg",
      ...
      ["translate", "scale", "rotate", "skew"].forEach((e) => {
        e1.forEach((t) => {
          e6.push(e + t), e4.set(e7(e + t), e3[e]);
        });
      });
      let e8 = (e, t) => e6.indexOf(e) - e6.indexOf(t),
        ...
        tt = (e, t) => {
          var r;
          e2[t] && (t = e2[t]);
          let { transforms: i } = e0(e);
          (r = t),
            -1 === i.indexOf(r) && i.push(r),
            (e.style.transform = tr(i));
        },
        ...
        tn = {
          ...
          finished: () =>
            !!ta({ opacity: [0, 1] }, { duration: 0.001 }).finished,
          linearEasing: () => {
            try {
              ta({ opacity: 0 }, { easing: "linear(0, 1)" });
            } catch (e) {
              return !1;
            }
            return !0;
        ...
        tc = {};
      for (let e in tn)
        tc[e] = () => (void 0 === ts[e] && (ts[e] = tn[e]()), ts[e]);
      let td = (e, t) => {
          let r = "",
            i = Math.round(t / 0.015);
      ...
      let tw = {
        ...
        tf = function (e, t, r = {}) {
          ...
          let s = (e = Array.from(i || [])).length;
          eG(!!s, "No valid element provided."),
            eG(!!t, "No keyframes defined.");
          let c = [];
          for (let i = 0; i < s; i++) {
            let o = e[i];
            for (let e in t) {
              let l = tv(r, e);
              l.delay = ((a = l.delay), (n = i), eV(a) ? a(n, s) : a);
              let d = (function (e, t, r, i = {}, o) {
                ...
                let $ = tu(t),
                  ...
                  A = e4.get($);
                return (
                  ek(C.animation, !(eR(p) && C.generator) && !1 !== i.record),
                  () => {
                    let l = () => {
                        var t, r;
                        return null !==
                          (r =
                            null !== (t = tw.get(e, $)) && void 0 !== t
                              ? t
                              : null == A
                              ? void 0
                              : A.initialValue) && void 0 !== r
                          ? r
                          : 0;
                      },
                      b = (function (e, t) {
                    ...
                    if (
                      (to($) &&
                        (tc.cssRegisterProperty()
                          ? (function (e) {
                              if (!tl.has(e)) {
                                tl.add(e);
                                try {
                                  let { syntax: t, initialValue: r } = e4.has(e)
                                    ? e4.get(e)
                                    : {};
                      ...
                      A && (b = b.map((e) => (eL(e) ? A.toDefaultUnit(e) : e))),
                        1 === b.length &&
                          (!tc.partialKeyframes() || s) &&
                          b.unshift(l());
                      let t = {
                        delay: e_.ms(d),
                        duration: e_.ms(c),
                      ...
                      a.finished
                        ...
                        .catch(eO),
                        v || (a.playbackRate = 1.000001);
                    } else if (o && y)
                      1 ===
                        (b = b.map((e) =>
                          "string" == typeof e ? parseFloat(e) : e
                        )).length && b.unshift(parseFloat(l())),
                        (a = new o(
                          (t) => {
                            tw.set(e, $, _ ? _(t) : t);
                          },
      ...
      var tx = r(92592),
        ...
        tE = (e, t) => {
          ...
          if (tC) for (var r of tC(t)) t_.call(t, r) && tO(e, r, t[r]);
          return e;
        };
      function tk() {
        return {
      ...
      let tI = {
          ...
          setTheme() {
            let e = document.querySelector(":root"),
              { themeVariables: t } = eC.ThemeCtrl.state;
            e &&
              Object.entries(
                tE(
                  tE(
                    tE(
                      ...
                      (function () {
                        ...
                        let t = {
                          ...
                          null != (e = eC.ThemeCtrl.state.themeMode)
                            ? e
                            : "dark"
                        ];
                        return {
              ...
              ).forEach(([t, r]) => e.style.setProperty(t, r));
          },
        ...
        tT = c`button{border-radius:var(--wcm-secondary-button-border-radius);height:28px;padding:0 10px;background-color:var(--wcm-accent-color)}button path{fill:var(--wcm-accent-fill-color)}button::after{border-radius:inherit;border:1px solid var(--wcm-color-overlay)}button:disabled::after{background-color:transparent}.wcm-icon-left svg{margin-right:5px}.wcm-icon-right svg{margin-left:5px}button:active::after{background-color:var(--wcm-color-overlay)}.wcm-ghost,.wcm-ghost:active::after,.wcm-outline{background-color:transparent}.wcm-ghost:active{opacity:.5}@media(hover:hover){button:hover::after{background-color:var(--wcm-color-overlay)}.wcm-ghost:hover::after{background-color:transparent}.wcm-ghost:hover{opacity:.5}}button:disabled{background-color:var(--wcm-color-bg-3);pointer-events:none}.wcm-ghost::after{border-color:transparent}.wcm-ghost path{fill:var(--wcm-color-fg-2)}.wcm-outline path{fill:var(--wcm-accent-color)}.wcm-outline:disabled{background-color:transparent;opacity:.5}`;
      var tP = Object.defineProperty,
        tM = Object.getOwnPropertyDescriptor,
        tS = (e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? tM(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
          return i && l && tP(t, r, l), l;
        };
      let tR = class extends es {
        constructor() {
          super(...arguments),
            (this.disabled = !1),
        ...
        render() {
          ...
          return (
            ...
            H`<button class="${eg(e)}" ?disabled="${this.disabled}" @click="${
              this.onClick
            }">${
              this.iconLeft
      ...
      (tR.styles = [tI.globalCss, tT]),
        tS([ep({ type: Boolean })], tR.prototype, "disabled", 2),
        tS([ep()], tR.prototype, "iconLeft", 2),
        tS([ep()], tR.prototype, "iconRight", 2),
        tS([ep()], tR.prototype, "onClick", 2),
        tS([ep()], tR.prototype, "variant", 2),
        (tR = tS([ed("wcm-button")], tR));
      let tL = c`:host{display:inline-block}button{padding:0 15px 1px;height:40px;border-radius:var(--wcm-button-border-radius);color:var(--wcm-accent-fill-color);background-color:var(--wcm-accent-color)}button::after{content:'';top:0;bottom:0;left:0;right:0;position:absolute;background-color:transparent;border-radius:inherit;transition:background-color .2s ease;border:1px solid var(--wcm-color-overlay)}button:active::after{background-color:var(--wcm-color-overlay)}button:disabled{padding-bottom:0;background-color:var(--wcm-color-bg-3);color:var(--wcm-color-fg-3)}.wcm-secondary{color:var(--wcm-accent-color);background-color:transparent}.wcm-secondary::after{display:none}@media(hover:hover){button:hover::after{background-color:var(--wcm-color-overlay)}}`;
      var tW = Object.defineProperty,
        tj = Object.getOwnPropertyDescriptor,
        tD = (e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? tj(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
      ...
      let tN = class extends es {
        constructor() {
          super(...arguments), (this.disabled = !1), (this.variant = "primary");
        }
        render() {
          let e = { "wcm-secondary": "secondary" === this.variant };
          return H`<button ?disabled="${this.disabled}" class="${eg(
            e
          )}"><slot></slot></button>`;
        }
      };
      (tN.styles = [tI.globalCss, tL]),
        tD([ep({ type: Boolean })], tN.prototype, "disabled", 2),
        tD([ep()], tN.prototype, "variant", 2),
        (tN = tD([ed("wcm-button-big")], tN));
      let tU = c`:host{background-color:var(--wcm-color-bg-2);border-top:1px solid var(--wcm-color-bg-3)}div{padding:10px 20px;display:inherit;flex-direction:inherit;align-items:inherit;width:inherit;justify-content:inherit}`;
      var tz = Object.defineProperty,
        tH = Object.getOwnPropertyDescriptor;
      let tZ = class extends es {
        render() {
          return H`<div><slot></slot></div>`;
        }
      };
      (tZ.styles = [tI.globalCss, tU]),
        (tZ = ((e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? tH(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
          return i && l && tz(t, r, l), l;
        })([ed("wcm-info-footer")], tZ));
      let tB = {
        ...
        tV = c`.wcm-toolbar-placeholder{top:0;bottom:0;left:0;right:0;width:100%;position:absolute;display:block;pointer-events:none;height:100px;border-radius:calc(var(--wcm-background-border-radius) * .9);background-color:var(--wcm-background-color);background-position:center;background-size:cover}.wcm-toolbar{height:38px;display:flex;position:relative;margin:5px 15px 5px 5px;justify-content:space-between;align-items:center}.wcm-toolbar img,.wcm-toolbar svg{height:28px;object-position:left center;object-fit:contain}#wcm-wc-logo path{fill:var(--wcm-accent-fill-color)}button{width:28px;height:28px;border-radius:var(--wcm-icon-button-border-radius);border:0;display:flex;justify-content:center;align-items:center;cursor:pointer;background-color:var(--wcm-color-bg-1);box-shadow:0 0 0 1px var(--wcm-color-overlay)}button:active{background-color:var(--wcm-color-bg-2)}button svg{display:block;object-position:center}button path{fill:var(--wcm-color-fg-1)}.wcm-toolbar div{display:flex}@media(hover:hover){button:hover{background-color:var(--wcm-color-bg-2)}}`;
      var tq = Object.defineProperty,
        tF = Object.getOwnPropertyDescriptor;
      let tK = class extends es {
        render() {
          return H`<div class="wcm-toolbar-placeholder"></div><div class="wcm-toolbar">${tB.WALLET_CONNECT_LOGO} <button @click="${eC.jb.close}">${tB.CROSS_ICON}</button></div>`;
        }
      };
      (tK.styles = [tI.globalCss, tV]),
        (tK = ((e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? tF(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
          return i && l && tq(t, r, l), l;
        })([ed("wcm-modal-backcard")], tK));
      let tQ = c`main{padding:20px;padding-top:0;width:100%}`;
      var tY = Object.defineProperty,
        tG = Object.getOwnPropertyDescriptor;
      let tX = class extends es {
        render() {
          return H`<main><slot></slot></main>`;
        }
      };
      (tX.styles = [tI.globalCss, tQ]),
        (tX = ((e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? tG(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
          return i && l && tY(t, r, l), l;
        })([ed("wcm-modal-content")], tX));
      let tJ = c`footer{padding:10px;display:flex;flex-direction:column;align-items:inherit;justify-content:inherit;border-top:1px solid var(--wcm-color-bg-2)}`;
      var t0 = Object.defineProperty,
        t1 = Object.getOwnPropertyDescriptor;
      let t2 = class extends es {
        render() {
          return H`<footer><slot></slot></footer>`;
        }
      };
      (t2.styles = [tI.globalCss, tJ]),
        (t2 = ((e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? t1(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
          return i && l && t0(t, r, l), l;
        })([ed("wcm-modal-footer")], t2));
      let t5 = c`header{display:flex;justify-content:center;align-items:center;padding:20px;position:relative}.wcm-border{border-bottom:1px solid var(--wcm-color-bg-2);margin-bottom:20px}header button{padding:15px 20px}header button:active{opacity:.5}@media(hover:hover){header button:hover{opacity:.5}}.wcm-back-btn{position:absolute;left:0}.wcm-action-btn{position:absolute;right:0}path{fill:var(--wcm-accent-color)}`;
      var t3 = Object.defineProperty,
        t4 = Object.getOwnPropertyDescriptor,
        t7 = (e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? t4(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
          return i && l && t3(t, r, l), l;
        };
      let t6 = class extends es {
        constructor() {
          super(...arguments),
            (this.title = ""),
        ...
        backBtnTemplate() {
          return H`<button class="wcm-back-btn" @click="${eC.AV.goBack}">${tB.BACK_ICON}</button>`;
        }
        actionBtnTemplate() {
        ...
        render() {
          let e = { "wcm-border": this.border },
            ...
            r = this.title
              ...
              : H`<slot></slot>`;
          return H`<header class="${eg(e)}">${
            t ? this.backBtnTemplate() : null
          } ${r} ${this.onAction ? this.actionBtnTemplate() : null}</header>`;
        }
      };
      (t6.styles = [tI.globalCss, t5]),
        t7([ep()], t6.prototype, "title", 2),
        t7([ep()], t6.prototype, "onAction", 2),
        t7([ep()], t6.prototype, "actionIcon", 2),
        t7([ep({ type: Boolean })], t6.prototype, "border", 2),
        (t6 = t7([ed("wcm-modal-header")], t6));
      let t8 = {
          ...
          getWalletIcon({ id: e, image_id: t }) {
            let { walletImages: r } = eC.ConfigCtrl.state;
            return null != r && r[e]
              ? r[e]
              : t
              ? eC.ExplorerCtrl.getWalletImageUrl(t)
              : "";
          },
          getWalletName: (e, t = !1) =>
          ...
          handleMobileLinking(e) {
            let t;
            let { walletConnectUri: r } = eC.OptionsCtrl.state,
              { mobile: i, name: o } = e,
              l = i?.native,
              a = i?.universal;
            t8.setRecentWallet(e),
              r &&
                ((t = ""),
                l
                  ? (t = eC.zv.formatUniversalUrl(l, r, o))
                  : a && (t = eC.zv.formatNativeUrl(a, r, o)),
                eC.zv.openHref(t, "_self"));
          },
          handleAndroidLinking() {
            let { walletConnectUri: e } = eC.OptionsCtrl.state;
            e &&
              (eC.zv.setWalletConnectAndroidDeepLink(e),
              eC.zv.openHref(e, "_self"));
          },
          async handleUriCopy() {
            let { walletConnectUri: e } = eC.OptionsCtrl.state;
            if (e)
              try {
                await navigator.clipboard.writeText(e),
                  eC.ToastCtrl.openToast("Link copied", "success");
              } catch {
                eC.ToastCtrl.openToast("Failed to copy", "error");
              }
          },
          getCustomImageUrls() {
            let { walletImages: e } = eC.ConfigCtrl.state;
          ...
          getCachedRouterWalletPlatforms() {
            let { desktop: e, mobile: t } = eC.zv.getWalletRouterData(),
              r = !!e?.native,
              i = !!e?.universal;
            return {
              isDesktop: r,
          ...
          goToConnectingView(e) {
            ...
            t
              ? o
                ? eC.AV.push("MobileConnecting")
                : i
                ? eC.AV.push("WebConnecting")
                : eC.AV.push("InstallWallet")
              : r
              ? eC.AV.push("DesktopConnecting")
              : i
              ? eC.AV.push("WebConnecting")
              : o
              ? eC.AV.push("MobileQrcodeConnecting")
              : eC.AV.push("InstallWallet");
          },
        },
        t9 = c`.wcm-router{overflow:hidden;will-change:transform}.wcm-content{display:flex;flex-direction:column}`;
      var re = Object.defineProperty,
        rt = Object.getOwnPropertyDescriptor,
        rr = (e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? rt(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
      ...
      let ri = class extends es {
        constructor() {
          super(),
            (this.view = eC.AV.state.view),
            (this.prevView = eC.AV.state.view),
            (this.unsubscribe = void 0),
            (this.oldHeight = "0px"),
            (this.resizeObserver = void 0),
            (this.unsubscribe = eC.AV.subscribe((e) => {
      ...
      (ri.styles = [tI.globalCss, t9]),
        rr([eu()], ri.prototype, "view", 2),
        rr([eu()], ri.prototype, "prevView", 2),
        (ri = rr([ed("wcm-modal-router")], ri));
      let ro = c`div{height:36px;width:max-content;display:flex;justify-content:center;align-items:center;padding:9px 15px 11px;position:absolute;top:12px;box-shadow:0 6px 14px -6px rgba(10,16,31,.3),0 10px 32px -4px rgba(10,16,31,.15);z-index:2;left:50%;transform:translateX(-50%);pointer-events:none;backdrop-filter:blur(20px) saturate(1.8);-webkit-backdrop-filter:blur(20px) saturate(1.8);border-radius:var(--wcm-notification-border-radius);border:1px solid var(--wcm-color-overlay);background-color:var(--wcm-color-overlay)}svg{margin-right:5px}@-moz-document url-prefix(){div{background-color:var(--wcm-color-bg-3)}}.wcm-success path{fill:var(--wcm-accent-color)}.wcm-error path{fill:var(--wcm-error-color)}`;
      var rl = Object.defineProperty,
        ra = Object.getOwnPropertyDescriptor,
        rn = (e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? ra(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
      ...
      let rs = class extends es {
        constructor() {
          super(),
            ...
            (this.unsubscribe = void 0),
            (this.timeout = void 0),
            (this.unsubscribe = eC.ToastCtrl.subscribe((e) => {
              e.open
                ? ((this.open = !0),
                  (this.timeout = setTimeout(
                    () => eC.ToastCtrl.closeToast(),
                    2200
                  )))
        ...
        render() {
          let { message: e, variant: t } = eC.ToastCtrl.state;
          return this.open
            ? H`<div class="${eg({
                "wcm-success": "success" === t,
                "wcm-error": "error" === t,
              })}">${"success" === t ? tB.CHECKMARK_ICON : null} ${
                "error" === t ? tB.CROSS_ICON : null
      ...
      (rs.styles = [tI.globalCss, ro]),
        rn([eu()], rs.prototype, "open", 2),
        (rs = rn([ed("wcm-modal-toast")], rs));
      let rd = {
          generate(e, t, r) {
            let i = "#141414",
              o = [],
              l = (function (e, t) {
                let r = Array.prototype.slice.call(
                    tx.create(e, { errorCorrectionLevel: "Q" }).modules.data,
                    0
                  ),
            ...
            return (
              ...
              Object.entries(m)
                ...
                .forEach(([e, t]) => {
                  t.forEach((t) => {
                    o.push(
                      Z`<circle cx="${e}" cy="${t}" fill="${i}" r="${a / 2.5}">`
                    );
                  });
                }),
              Object.entries(m)
                ...
                .forEach(([e, t]) => {
                  t.forEach(([t, r]) => {
                    o.push(
                      Z`<line x1="${e}" x2="${e}" y1="${t}" y2="${r}" stroke="${i}" stroke-width="${
                        a / 1.25
      ...
      let rw = class extends es {
        ...
        svgTemplate() {
          let e =
            "light" === eC.ThemeCtrl.state.themeMode
              ? this.size
              : this.size - 36;
          return Z`<svg height="${e}" width="${e}">${rd.generate(
            this.uri,
            e,
            e / 4
          )}</svg>`;
        ...
        render() {
          let e = { "wcm-dark": "dark" === eC.ThemeCtrl.state.themeMode };
          return H`<div style="${`width: ${this.size}px`}" class="${eg(e)}">${
            this.walletId || this.imageUrl
              ? H`<wcm-wallet-image walletId="${ty(
                  this.walletId
                )}" imageId="${ty(this.imageId)}" imageUrl="${ty(
                  this.imageUrl
                )}"></wcm-wallet-image>`
              : tB.WALLET_CONNECT_ICON_COLORED
          } ${this.svgTemplate()}</div>`;
        }
      };
      (rw.styles = [tI.globalCss, rh]),
        ru([ep()], rw.prototype, "uri", 2),
        ru([ep({ type: Number })], rw.prototype, "size", 2),
        ru([ep()], rw.prototype, "imageId", 2),
        ru([ep()], rw.prototype, "walletId", 2),
        ru([ep()], rw.prototype, "imageUrl", 2),
        (rw = ru([ed("wcm-qrcode")], rw));
      ...
      var rv = Object.defineProperty,
        ...
        rb = (e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? rf(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
      ...
      let ry = class extends es {
        constructor() {
          super(...arguments), (this.onChange = () => null);
        }
        render() {
          return H`<input type="text" @input="${this.onChange}" placeholder="Search wallets"> ${tB.SEARCH_ICON}`;
        }
      };
      (ry.styles = [tI.globalCss, rg]),
        rb([ep()], ry.prototype, "onChange", 2),
        (ry = rb([ed("wcm-search-input")], ry));
      let rx = c`@keyframes rotate{100%{transform:rotate(360deg)}}@keyframes dash{0%{stroke-dasharray:1,150;stroke-dashoffset:0}50%{stroke-dasharray:90,150;stroke-dashoffset:-35}100%{stroke-dasharray:90,150;stroke-dashoffset:-124}}svg{animation:rotate 2s linear infinite;display:flex;justify-content:center;align-items:center}svg circle{stroke-linecap:round;animation:dash 1.5s ease infinite;stroke:var(--wcm-accent-color)}`;
      var r$ = Object.defineProperty,
        rC = Object.getOwnPropertyDescriptor;
      let rA = class extends es {
        render() {
          return H`<svg viewBox="0 0 50 50" width="24" height="24"><circle cx="25" cy="25" r="20" fill="none" stroke-width="4" stroke="#fff"/></svg>`;
        }
      };
      (rA.styles = [tI.globalCss, rx]),
        (rA = ((e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? rC(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
      ...
      var rO = Object.defineProperty,
        ...
        rk = (e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? rE(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
      ...
      let rI = class extends es {
        ...
        render() {
          ...
          return H`<span><slot class="${eg(e)}"></slot></span>`;
        }
      };
      (rI.styles = [tI.globalCss, r_]),
        rk([ep()], rI.prototype, "variant", 2),
        rk([ep()], rI.prototype, "color", 2),
        (rI = rk([ed("wcm-text")], rI));
      let rT = c`button{width:100%;height:100%;border-radius:var(--wcm-button-hover-highlight-border-radius);display:flex;align-items:flex-start}button:active{background-color:var(--wcm-color-overlay)}@media(hover:hover){button:hover{background-color:var(--wcm-color-overlay)}}button>div{width:80px;padding:5px 0;display:flex;flex-direction:column;align-items:center}wcm-text{width:100%;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;text-align:center}wcm-wallet-image{height:60px;width:60px;transition:all .2s ease;border-radius:var(--wcm-wallet-icon-border-radius);margin-bottom:5px}.wcm-sublabel{margin-top:2px}`;
      var rP = Object.defineProperty,
        rM = Object.getOwnPropertyDescriptor,
        rS = (e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? rM(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
      ...
      let rR = class extends es {
        ...
        handleClick() {
          eC.uA.click({ name: "WALLET_BUTTON", walletId: this.walletId }),
            this.onClick();
        }
        render() {
          var e;
          return H`<button @click="${this.handleClick.bind(
            this
          )}"><div><wcm-wallet-image walletId="${this.walletId}" imageId="${ty(
            this.imageId
          )}"></wcm-wallet-image><wcm-text variant="xsmall-regular">${
            null != (e = this.label) ? e : t8.getWalletName(this.name, !0)
          }</wcm-text>${this.sublabelTemplate()}</div></button>`;
        }
      };
      (rR.styles = [tI.globalCss, rT]),
        rS([ep()], rR.prototype, "onClick", 2),
        rS([ep()], rR.prototype, "name", 2),
        rS([ep()], rR.prototype, "walletId", 2),
        rS([ep()], rR.prototype, "label", 2),
        rS([ep()], rR.prototype, "imageId", 2),
        rS([ep({ type: Boolean })], rR.prototype, "installed", 2),
        rS([ep({ type: Boolean })], rR.prototype, "recent", 2),
        (rR = rS([ed("wcm-wallet-button")], rR));
      ...
      var rW = Object.defineProperty,
        ...
        rD = (e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? rj(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
        ...
        render() {
          ...
          let t =
            null != (e = this.imageUrl) && e.length
              ? this.imageUrl
              : t8.getWalletIcon({ id: this.walletId, image_id: this.imageId });
          return H`${
            t.length
              ? H`<div><img crossorigin="anonymous" src="${t}" alt="${this.id}"></div>`
              : tB.WALLET_PLACEHOLDER
          }`;
        }
      };
      (rN.styles = [tI.globalCss, rL]),
        rD([ep()], rN.prototype, "walletId", 2),
        rD([ep()], rN.prototype, "imageId", 2),
        rD([ep()], rN.prototype, "imageUrl", 2),
        (rN = rD([ed("wcm-wallet-image")], rN));
      var rU = Object.defineProperty,
        rz = Object.getOwnPropertyDescriptor,
        rH = (e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? rz(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
      ...
      let rZ = class extends es {
        ...
        async loadImages(e) {
          try {
            null != e &&
              e.length &&
              (await Promise.all(e.map(async (e) => t8.preloadImage(e))));
          } catch {
        ...
        async preloadListings() {
          if (eC.ConfigCtrl.state.enableExplorer) {
            await eC.ExplorerCtrl.getRecomendedWallets(),
              eC.OptionsCtrl.setIsDataLoaded(!0);
            let { recomendedWallets: e } = eC.ExplorerCtrl.state,
              t = e.map((e) => t8.getWalletIcon(e));
        ...
        async preloadData() {
          try {
            ...
            console.error(e),
              eC.ToastCtrl.openToast("Failed preloading", "error");
          }
        }
      };
      rH([eu()], rZ.prototype, "preload", 2),
        (rZ = rH([ed("wcm-explorer-context")], rZ));
      var rB = Object.defineProperty,
        rV = Object.getOwnPropertyDescriptor;
      let rq = class extends es {
        constructor() {
          super(),
            (this.unsubscribeTheme = void 0),
            tI.setTheme(),
            (this.unsubscribeTheme = eC.ThemeCtrl.subscribe(tI.setTheme));
        }
        disconnectedCallback() {
          var e;
      ...
      let rY = class extends es {
        ...
        render() {
          let { recomendedWallets: e } = eC.ExplorerCtrl.state,
            t = [...e, ...e],
            r = 2 * eC.zv.RECOMMENDED_WALLET_AMOUNT;
      ...
      (rY.styles = [tI.globalCss, rF]),
        (rY = ((e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? rQ(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
          return i && l && rK(t, r, l), l;
        })([ed("wcm-android-wallet-selection")], rY));
      ...
      let r1 = class extends es {
        ...
        svgLoaderTemplate() {
          ...
          let r =
              null !=
              (t =
                null == (e = eC.ThemeCtrl.state.themeVariables)
                  ? void 0
                  : e["--wcm-wallet-icon-large-border-radius"])
                ? t
                : tI.getPreset("--wcm-wallet-icon-large-border-radius"),
            i = 0,
            o =
              317 -
              1.57 *
                (i =
                  (r.includes("%") ? 0.88 * parseInt(r, 10) : parseInt(r, 10)) *
                  1.17),
            l = 425 - 1.8 * i;
        ...
        render() {
          ...
          return H`<div class="${eg(
            e
          )}">${this.svgLoaderTemplate()}<wcm-wallet-image walletId="${ty(
            this.walletId
          )}" imageId="${ty(
            this.imageId
      ...
      (r1.styles = [tI.globalCss, rG]),
        r0([ep()], r1.prototype, "walletId", 2),
        r0([ep()], r1.prototype, "imageId", 2),
        r0([ep({ type: Boolean })], r1.prototype, "isError", 2),
        r0([ep({ type: Boolean })], r1.prototype, "isStale", 2),
        r0([ep()], r1.prototype, "label", 2),
        (r1 = r0([ed("wcm-connector-waiting")], r1));
      let r2 = {
          manualWallets() {
            var e, t;
            let { mobileWallets: r, desktopWallets: i } = eC.ConfigCtrl.state,
              o = null == (e = r2.recentWallet()) ? void 0 : e.id,
              l = eC.zv.isMobile() ? r : i,
              a = l?.filter((e) => o !== e.id);
            return null !=
              (t = eC.zv.isMobile()
                ? a?.map(({ id: e, name: t, links: r }) => ({
                    id: e,
                    name: t,
                    mobile: r,
                    links: r,
          ...
          recomendedWallets(e = !1) {
            ...
            let r = e || null == (t = r2.recentWallet()) ? void 0 : t.id,
              { recomendedWallets: i } = eC.ExplorerCtrl.state;
        ...
        r5 = {
          ...
          recomendedWalletsTemplate(e = !1) {
            return r2
              ...
              .map(
                (e) =>
                  H`<wcm-wallet-button name="${e.name}" walletId="${
                    e.id
          ...
          recentWalletTemplate() {
            ...
            if (e)
              return H`<wcm-wallet-button name="${e.name}" walletId="${
                e.id
              }" imageId="${ty(e.image_id)}" .recent="${!0}" .onClick="${() =>
                this.onConnecting(e)}"></wcm-wallet-button>`;
          },
        },
      ...
      let r6 = class extends es {
        render() {
          let { explorerExcludedWalletIds: e, enableExplorer: t } =
              eC.ConfigCtrl.state,
            r = r5.manualWalletsTemplate(),
            i = r5.recomendedWalletsTemplate(),
            o = [r5.recentWalletTemplate(), ...r, ...i],
            l = (o = o.filter(Boolean)).length > 4 || ("ALL" !== e && t),
            a = [],
            n = !!(a = l ? o.slice(0, 3) : o).length;
          return H`<wcm-modal-header .border="${!0}" title="Connect your wallet" .onAction="${
            ...
            n
              ? H`<wcm-modal-footer><div class="wcm-desktop-title">${
                  tB.DESKTOP_ICON
                }<wcm-text variant="small-regular" color="accent">Desktop</wcm-text></div><div class="wcm-grid">${a} ${
                  l
      ...
      (r6.styles = [tI.globalCss, r3]),
        (r6 = ((e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? r7(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
          return i && l && r4(t, r, l), l;
        })([ed("wcm-desktop-wallet-selection")], r6));
      let r8 = c`div{background-color:var(--wcm-color-bg-2);padding:10px 20px 15px 20px;border-top:1px solid var(--wcm-color-bg-3);text-align:center}a{color:var(--wcm-accent-color);text-decoration:none;transition:opacity .2s ease-in-out;display:inline}a:active{opacity:.8}@media(hover:hover){a:hover{opacity:.8}}`;
      var r9 = Object.defineProperty,
        ie = Object.getOwnPropertyDescriptor;
      let it = class extends es {
        render() {
      ...
      (it.styles = [tI.globalCss, r8]),
        (it = ((e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? ie(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
          return i && l && r9(t, r, l), l;
        })([ed("wcm-legal-notice")], it));
      let ir = c`div{display:grid;grid-template-columns:repeat(4,80px);margin:0 -10px;justify-content:space-between;row-gap:10px}`;
      var ii = Object.defineProperty,
        io = Object.getOwnPropertyDescriptor;
      let il = class extends es {
        onQrcode() {
          eC.AV.push("Qrcode");
        }
        render() {
          let { explorerExcludedWalletIds: e, enableExplorer: t } =
            ...
            i = r5.recomendedWalletsTemplate(),
            o = [r5.recentWalletTemplate(), ...r, ...i],
            l = (o = o.filter(Boolean)).length > 8 || ("ALL" !== e && t),
            a = [],
            n = !!(a = l ? o.slice(0, 7) : o).length;
          return H`<wcm-modal-header title="Connect your wallet" .onAction="${
            this.onQrcode
          }" .actionIcon="${tB.QRCODE_ICON}"></wcm-modal-header>${
            n
              ? H`<wcm-modal-content><div>${a} ${
                  l
                    ? H`<wcm-view-all-wallets-button></wcm-view-all-wallets-button>`
                    : null
      ...
      (il.styles = [tI.globalCss, ir]),
        (il = ((e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? io(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
          return i && l && ii(t, r, l), l;
        })([ed("wcm-mobile-wallet-selection")], il));
      let ia = c`:host{all:initial}.wcm-overlay{top:0;bottom:0;left:0;right:0;position:fixed;z-index:var(--wcm-z-index);overflow:hidden;display:flex;justify-content:center;align-items:center;opacity:0;pointer-events:none;background-color:var(--wcm-overlay-background-color);backdrop-filter:var(--wcm-overlay-backdrop-filter)}@media(max-height:720px) and (orientation:landscape){.wcm-overlay{overflow:scroll;align-items:flex-start;padding:20px 0}}.wcm-active{pointer-events:auto}.wcm-container{position:relative;max-width:360px;width:100%;outline:0;border-radius:var(--wcm-background-border-radius) var(--wcm-background-border-radius) var(--wcm-container-border-radius) var(--wcm-container-border-radius);border:1px solid var(--wcm-color-overlay);overflow:hidden}.wcm-card{width:100%;position:relative;border-radius:var(--wcm-container-border-radius);overflow:hidden;box-shadow:0 6px 14px -6px rgba(10,16,31,.12),0 10px 32px -4px rgba(10,16,31,.1),0 0 0 1px var(--wcm-color-overlay);background-color:var(--wcm-color-bg-1);color:var(--wcm-color-fg-1)}@media(max-width:600px){.wcm-container{max-width:440px;border-radius:var(--wcm-background-border-radius) var(--wcm-background-border-radius) 0 0}.wcm-card{border-radius:var(--wcm-container-border-radius) var(--wcm-container-border-radius) 0 0}.wcm-overlay{align-items:flex-end}}@media(max-width:440px){.wcm-container{border:0}}`;
      var is = Object.defineProperty,
        ic = Object.getOwnPropertyDescriptor,
        id = (e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? ic(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
      ...
      let ih = class extends es {
        constructor() {
          super(),
            ...
            (this.unsubscribeModal = eC.jb.subscribe((e) => {
          ...
          this.toggleBodyScroll(!1),
            ...
            setTimeout(async () => {
              ...
              await Promise.all([
                ...
                tb(this.containerEl, e, { delay: 0.1, duration: 0.2 }).finished,
              ]),
                (this.active = !0);
            }, 0);
        }
        async onCloseModalEvent() {
          ...
          let e = t8.isMobileAnimation()
            ...
            : { scale: [1, 0.98] };
          await Promise.all([
            tb(this.overlayEl, { opacity: [1, 0] }, { duration: 0.2 }).finished,
            tb(this.containerEl, e, { duration: 0.2 }).finished,
          ]),
        ...
        render() {
          ...
          return H`<wcm-explorer-context></wcm-explorer-context><wcm-theme-context></wcm-theme-context><div id="wcm-modal" class="${eg(
            e
          )}" @click="${
            this.onCloseModal
      ...
      (ih.styles = [tI.globalCss, ia]),
        id([eu()], ih.prototype, "open", 2),
        id([eu()], ih.prototype, "active", 2),
        (ih = id([ed("wcm-modal")], ih));
      let im = c`div{display:flex;margin-top:15px}slot{display:inline-block;margin:0 5px}wcm-button{margin:0 5px}`;
      var ip = Object.defineProperty,
        iu = Object.getOwnPropertyDescriptor,
        iw = (e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? iu(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
      ...
      let ig = class extends es {
        ...
        onMobile() {
          eC.zv.isMobile()
            ? eC.AV.replace("MobileConnecting")
            : eC.AV.replace("MobileQrcodeConnecting");
        }
        onDesktop() {
        ...
        render() {
          return H`<div>${this.isRetry ? H`<slot></slot>` : null} ${
            this.isMobile
              ? H`<wcm-button .onClick="${this.onMobile}" .iconLeft="${tB.MOBILE_ICON}" variant="outline">Mobile</wcm-button>`
              : null
          } ${
            this.isDesktop
              ? H`<wcm-button .onClick="${this.onDesktop}" .iconLeft="${tB.DESKTOP_ICON}" variant="outline">Desktop</wcm-button>`
              : null
          } ${
            this.isWeb
              ? H`<wcm-button .onClick="${this.onWeb}" .iconLeft="${tB.GLOBE_ICON}" variant="outline">Web</wcm-button>`
              : null
          }</div>`;
        }
      };
      (ig.styles = [tI.globalCss, im]),
        iw([ep({ type: Boolean })], ig.prototype, "isMobile", 2),
        iw([ep({ type: Boolean })], ig.prototype, "isDesktop", 2),
        iw([ep({ type: Boolean })], ig.prototype, "isWeb", 2),
        iw([ep({ type: Boolean })], ig.prototype, "isRetry", 2),
        (ig = iw([ed("wcm-platform-selection")], ig));
      let iv = c`button{display:flex;flex-direction:column;padding:5px 10px;border-radius:var(--wcm-button-hover-highlight-border-radius);height:100%;justify-content:flex-start}.wcm-icons{width:60px;height:60px;display:flex;flex-wrap:wrap;padding:7px;border-radius:var(--wcm-wallet-icon-border-radius);justify-content:space-between;align-items:center;margin-bottom:5px;background-color:var(--wcm-color-bg-2);box-shadow:inset 0 0 0 1px var(--wcm-color-overlay)}button:active{background-color:var(--wcm-color-overlay)}@media(hover:hover){button:hover{background-color:var(--wcm-color-overlay)}}.wcm-icons img{width:21px;height:21px;object-fit:cover;object-position:center;border-radius:calc(var(--wcm-wallet-icon-border-radius)/ 2);border:1px solid var(--wcm-color-overlay)}.wcm-icons svg{width:21px;height:21px}.wcm-icons img:nth-child(1),.wcm-icons img:nth-child(2),.wcm-icons svg:nth-child(1),.wcm-icons svg:nth-child(2){margin-bottom:4px}wcm-text{width:100%;text-align:center}#wallet-placeholder-fill{fill:var(--wcm-color-bg-3)}#wallet-placeholder-dash{stroke:var(--wcm-color-overlay)}`;
      ...
      let ix = class extends es {
        ...
        render() {
          let { recomendedWallets: e } = eC.ExplorerCtrl.state,
            t = [...e, ...r2.manualWallets()].reverse().slice(0, 4);
          return H`<button @click="${
            this.onClick
          }"><div class="wcm-icons">${t.map((e) => {
            let t = t8.getWalletIcon(e);
            if (t) return H`<img crossorigin="anonymous" src="${t}">`;
            let r = t8.getWalletIcon({ id: e.id });
            return r
      ...
      (ix.styles = [tI.globalCss, iv]),
        (ix = ((e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? iy(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
          return i && l && ib(t, r, l), l;
        })([ed("wcm-view-all-wallets-button")], ix));
      let i$ = c`.wcm-qr-container{width:100%;display:flex;justify-content:center;align-items:center;aspect-ratio:1/1}`;
      var iC = Object.defineProperty,
        iA = Object.getOwnPropertyDescriptor,
        i_ = (e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? iA(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
          ...
          return H`<div class="wcm-qr-container">${
            this.uri
              ? H`<wcm-qrcode size="${this.overlayEl.offsetWidth}" uri="${
                  this.uri
                }" walletId="${ty(this.walletId)}" imageId="${ty(
                  this.imageId
                )}"></wcm-qrcode>`
      ...
      (iO.styles = [tI.globalCss, i$]),
        i_([ep()], iO.prototype, "walletId", 2),
        i_([ep()], iO.prototype, "imageId", 2),
        i_([eu()], iO.prototype, "uri", 2),
        (iO = i_([ed("wcm-walletconnect-qr")], iO));
      var iE = Object.defineProperty,
        ik = Object.getOwnPropertyDescriptor;
      let iI = class extends es {
        viewTemplate() {
          return eC.zv.isAndroid()
      ...
      (iI.styles = [tI.globalCss]),
        (iI = ((e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? ik(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
          return i && l && iE(t, r, l), l;
        })([ed("wcm-connect-wallet-view")], iI));
      let iT = c`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
      var iP = Object.defineProperty,
        iM = Object.getOwnPropertyDescriptor,
        iS = (e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? iM(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
      ...
      let iR = class extends es {
        constructor() {
          super(), (this.isError = !1), this.openDesktopApp();
        }
        onFormatAndRedirect(e) {
          let { desktop: t, name: r } = eC.zv.getWalletRouterData(),
            i = t?.native;
          if (i) {
        ...
        openDesktopApp() {
          let { walletConnectUri: e } = eC.OptionsCtrl.state,
            t = eC.zv.getWalletRouterData();
          t8.setRecentWallet(t), e && this.onFormatAndRedirect(e);
        }
        render() {
          let { name: e, id: t, image_id: r } = eC.zv.getWalletRouterData(),
            { isMobile: i, isWeb: o } = t8.getCachedRouterWalletPlatforms();
          return H`<wcm-modal-header title="${e}" .onAction="${
            t8.handleUriCopy
          }" .actionIcon="${
            tB.COPY_ICON
          }"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${t}" imageId="${ty(
            r
          )}" label="${`Continue in ${e}...`}" .isError="${
            this.isError
          }"></wcm-connector-waiting></wcm-modal-content><wcm-info-footer><wcm-text color="secondary" variant="small-thin">${`Connection can continue loading if ${e} is not installed on your device`}</wcm-text><wcm-platform-selection .isMobile="${i}" .isWeb="${o}" .isRetry="${!0}"><wcm-button .onClick="${this.openDesktopApp.bind(
            this
          )}" .iconRight="${
            tB.RETRY_ICON
      ...
      (iR.styles = [tI.globalCss, iT]),
        iS([eu()], iR.prototype, "isError", 2),
        (iR = iS([ed("wcm-desktop-connecting-view")], iR));
      let iL = c`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}wcm-button{margin-top:15px}`;
      var iW = Object.defineProperty,
        ij = Object.getOwnPropertyDescriptor;
      let iD = class extends es {
        onInstall(e) {
        ...
        render() {
          ...
          return H`<wcm-modal-header title="${e}"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${t}" imageId="${ty(
            r
      ...
      let iZ = class extends es {
        ...
        onFormatAndRedirect(e, t = !1) {
          let { mobile: r, name: i } = eC.zv.getWalletRouterData(),
            o = r?.native,
            l = r?.universal;
          if (o && !t) {
        ...
        openMobileApp(e = !1) {
          let { walletConnectUri: t } = eC.OptionsCtrl.state,
            r = eC.zv.getWalletRouterData();
        ...
        render() {
          let {
            ...
            { isWeb: l } = t8.getCachedRouterWalletPlatforms(),
            a = i?.ios,
            n = o?.universal;
          return H`<wcm-modal-header title="${e}"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${t}" imageId="${ty(
            r
            ...
            this.isError
          }"></wcm-connector-waiting></wcm-modal-content><wcm-info-footer class="wcm-note"><wcm-platform-selection .isWeb="${l}" .isRetry="${!0}"><wcm-button .onClick="${() =>
            ...
            n
              ...
              : null
          }</wcm-info-footer><wcm-info-footer class="wcm-app-store"><div><wcm-wallet-image walletId="${t}" imageId="${ty(
            r
      ...
      (iZ.styles = [tI.globalCss, iN]),
        iH([eu()], iZ.prototype, "isError", 2),
        (iZ = iH([ed("wcm-mobile-connecting-view")], iZ));
      let iB = c`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
      var iV = Object.defineProperty,
        iq = Object.getOwnPropertyDescriptor;
      let iF = class extends es {
        render() {
          let { name: e, id: t, image_id: r } = eC.zv.getWalletRouterData(),
            { isDesktop: i, isWeb: o } = t8.getCachedRouterWalletPlatforms();
          return H`<wcm-modal-header title="${e}" .onAction="${
            t8.handleUriCopy
          }" .actionIcon="${
            tB.COPY_ICON
          }"></wcm-modal-header><wcm-modal-content><wcm-walletconnect-qr walletId="${t}" imageId="${ty(
            r
          )}"></wcm-walletconnect-qr></wcm-modal-content><wcm-info-footer><wcm-text color="secondary" variant="small-thin">${`Scan this QR Code with your phone's camera or inside ${e} app`}</wcm-text><wcm-platform-selection .isDesktop="${i}" .isWeb="${o}"></wcm-platform-selection></wcm-info-footer>`;
        }
      };
      (iF.styles = [tI.globalCss, iB]),
        (iF = ((e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? iq(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
          return i && l && iV(t, r, l), l;
        })([ed("wcm-mobile-qr-connecting-view")], iF));
      var iK = Object.defineProperty,
        iQ = Object.getOwnPropertyDescriptor;
      let iY = class extends es {
        render() {
          return H`<wcm-modal-header title="Scan the code" .onAction="${t8.handleUriCopy}" .actionIcon="${tB.COPY_ICON}"></wcm-modal-header><wcm-modal-content><wcm-walletconnect-qr></wcm-walletconnect-qr></wcm-modal-content>`;
        }
      };
      (iY.styles = [tI.globalCss]),
        (iY = ((e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? iQ(t, r) : t, a = e.length - 1;
            a >= 0;
        ...
        })([ed("wcm-qrcode-view")], iY));
      let iG = c`wcm-modal-content{height:clamp(200px,60vh,600px);display:block;overflow:scroll;scrollbar-width:none;position:relative;margin-top:1px}.wcm-grid{display:grid;grid-template-columns:repeat(4,80px);justify-content:space-between;margin:-15px -10px;padding-top:20px}wcm-modal-content::after,wcm-modal-content::before{content:'';position:fixed;pointer-events:none;z-index:1;width:100%;height:20px;opacity:1}wcm-modal-content::before{box-shadow:0 -1px 0 0 var(--wcm-color-bg-1);background:linear-gradient(var(--wcm-color-bg-1),rgba(255,255,255,0))}wcm-modal-content::after{box-shadow:0 1px 0 0 var(--wcm-color-bg-1);background:linear-gradient(rgba(255,255,255,0),var(--wcm-color-bg-1));top:calc(100% - 20px)}wcm-modal-content::-webkit-scrollbar{display:none}.wcm-placeholder-block{display:flex;justify-content:center;align-items:center;height:100px;overflow:hidden}.wcm-empty,.wcm-loading{display:flex}.wcm-loading .wcm-placeholder-block{height:100%}.wcm-end-reached .wcm-placeholder-block{height:0;opacity:0}.wcm-empty .wcm-placeholder-block{opacity:1;height:100%}wcm-wallet-button{margin:calc((100% - 60px)/ 3) 0}`;
      ...
      let i1 = class extends es {
        constructor() {
          super(...arguments),
            (this.loading = !eC.ExplorerCtrl.state.wallets.listings.length),
            (this.firstFetch = !eC.ExplorerCtrl.state.wallets.listings.length),
            (this.search = ""),
            (this.endReached = !1),
            (this.intersectionObserver = void 0),
            (this.searchDebounce = t8.debounce((e) => {
              e.length >= 1
                ? ((this.firstFetch = !0),
                  (this.endReached = !1),
                  (this.search = e),
                  eC.ExplorerCtrl.resetSearch(),
                  this.fetchWallets())
                : this.search &&
                  ((this.search = ""),
        ...
        isLastPage() {
          let { wallets: e, search: t } = eC.ExplorerCtrl.state,
            { listings: r, total: i } = this.search ? t : e;
          return i <= 40 || r.length >= i;
        }
        async fetchWallets() {
          var e;
          let { wallets: t, search: r } = eC.ExplorerCtrl.state,
            { listings: i, total: o, page: l } = this.search ? r : t;
          if (!this.endReached && (this.firstFetch || (o > 40 && i.length < o)))
            try {
              this.loading = !0;
              let t =
                  null == (e = eC.OptionsCtrl.state.chains)
                    ? void 0
                    : e.join(","),
                { listings: r } = await eC.ExplorerCtrl.getWallets({
              ...
              await Promise.all([
                ...i.map(async (e) => t8.preloadImage(e)),
                eC.zv.wait(300),
              ]),
                (this.endReached = this.isLastPage());
            } catch (e) {
              console.error(e),
                eC.ToastCtrl.openToast(t8.getErrorMessage(e), "error");
            } finally {
        ...
        render() {
          let { wallets: e, search: t } = eC.ExplorerCtrl.state,
            ...
            l = r5.manualWalletsTemplate(),
            a = r5.recomendedWalletsTemplate(!0);
          o &&
            ((l = l.filter(({ values: e }) =>
          ...
          return H`<wcm-modal-header><wcm-search-input .onChange="${this.onSearchChange.bind(
            this
          )}"></wcm-search-input></wcm-modal-header><wcm-modal-content class="${eg(
            s
          )}"><div class="wcm-grid">${i ? null : l} ${i ? null : a} ${
            i
              ? null
              : r.map(
                  (e) =>
                    H`${
                      e
                        ? H`<wcm-wallet-button imageId="${e.image_id}" name="${
                            e.name
            ...
            !n && this.loading ? H`<wcm-spinner></wcm-spinner>` : null
          }</div></wcm-modal-content>`;
        }
      };
      (i1.styles = [tI.globalCss, iG]),
        i0([eu()], i1.prototype, "loading", 2),
        i0([eu()], i1.prototype, "firstFetch", 2),
        i0([eu()], i1.prototype, "search", 2),
        i0([eu()], i1.prototype, "endReached", 2),
        (i1 = i0([ed("wcm-wallet-explorer-view")], i1));
      let i2 = c`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
      var i5 = Object.defineProperty,
        i3 = Object.getOwnPropertyDescriptor,
        i4 = (e, t, r, i) => {
          for (
            var o, l = i > 1 ? void 0 : i ? i3(t, r) : t, a = e.length - 1;
            a >= 0;
            a--
          )
            (o = e[a]) && (l = (i ? o(t, r, l) : o(l)) || l);
      ...
      let i7 = class extends es {
        ...
        render() {
          let { name: e, id: t, image_id: r } = eC.zv.getWalletRouterData(),
            { isMobile: i, isDesktop: o } = t8.getCachedRouterWalletPlatforms(),
            l = eC.zv.isMobile();
          return H`<wcm-modal-header title="${e}" .onAction="${
            t8.handleUriCopy
          }" .actionIcon="${
            ...
            this.isError
          }"></wcm-connector-waiting></wcm-modal-content><wcm-info-footer><wcm-text color="secondary" variant="small-thin">${`${e} web app has opened in a new tab. Go there, accept the connection, and come back`}</wcm-text><wcm-platform-selection .isMobile="${i}" .isDesktop="${
            !l && o
      ...
      (i7.styles = [tI.globalCss, i2]),
        i4([eu()], i7.prototype, "isError", 2),
        (i7 = i4([ed("wcm-web-connecting-view")], i7));
    },
  },
]);
